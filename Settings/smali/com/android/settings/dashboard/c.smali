...
.field private UP:Lcom/android/settings/dashboard/DashboardTile;
...
.method public aG(Z)V
    ...
    .prologue
    .line 81
    iget-object v1, p0, Lcom/android/settings/dashboard/c;->UN:Landroid/view/View;
...
.method getColumnSpan()I
    ...
    .prologue
    .line 89
    iget v0, p0, Lcom/android/settings/dashboard/c;->UO:I
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 94
    iget-object v0, p0, Lcom/android/settings/dashboard/c;->UP:Lcom/android/settings/dashboard/DashboardTile;
    ...
    iget-object v1, p0, Lcom/android/settings/dashboard/c;->UP:Lcom/android/settings/dashboard/DashboardTile;

    iget-object v1, v1, Lcom/android/settings/dashboard/DashboardTile;->fragment:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/settings/dashboard/c;->UP:Lcom/android/settings/dashboard/DashboardTile;

    iget-object v2, v2, Lcom/android/settings/dashboard/DashboardTile;->fragmentArguments:Landroid/os/Bundle;

    const/4 v3, 0x0

    iget-object v5, p0, Lcom/android/settings/dashboard/c;->UP:Lcom/android/settings/dashboard/DashboardTile;

    iget v5, v5, Lcom/android/settings/dashboard/DashboardTile;->titleRes:I

    iget-object v6, p0, Lcom/android/settings/dashboard/c;->UP:Lcom/android/settings/dashboard/DashboardTile;
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/settings/iE;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;IILjava/lang/CharSequence;)V
    ...
    invoke-static {v0, v1}, Lcom/android/settings/gl;->a(Landroid/app/FragmentManager;Lcom/android/settings/dashboard/DashboardTile;)V
