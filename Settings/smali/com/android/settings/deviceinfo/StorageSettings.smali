...
.field private Xe:Landroid/preference/PreferenceCategory;

.field private Xf:Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xb:I
    ...
    sput v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xc:I
    ...
    sput-object v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xd:[I
    ...
    sput-object v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->ig:Lcom/android/settings_ex/search/l;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wl:Landroid/os/storage/StorageEventListener;

    .line 407
    return-void
.end method

.method static synthetic a(Lcom/android/settings_ex/deviceinfo/StorageSettings;)V
    .locals 0
...
.method static synthetic c(Landroid/os/storage/VolumeInfo;)Z
    ...
    .prologue
    .line 60
    invoke-static {p0}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->a(Landroid/os/storage/VolumeInfo;)Z
...
.method private refresh()V
    ...
    iget-object v2, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wn:Landroid/preference/PreferenceCategory;
    ...
    iget-object v2, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xe:Landroid/preference/PreferenceCategory;
    ...
    iget-object v3, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xf:Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;
    ...
    iget-object v7, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;
    ...
    .line 155
    sget-object v11, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xd:[I

    add-int/lit8 v8, v3, 0x1

    sget-object v12, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xd:[I
    ...
    iget-object v11, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wn:Landroid/preference/PreferenceCategory;

    new-instance v12, Lcom/android/settings_ex/deviceinfo/StorageVolumePreference;

    invoke-direct {v12, v9, v2, v3}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreference;-><init>(Landroid/content/Context;Landroid/os/storage/VolumeInfo;I)V
    ...
    iget-object v8, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xe:Landroid/preference/PreferenceCategory;

    new-instance v11, Lcom/android/settings_ex/deviceinfo/StorageVolumePreference;

    sget v12, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xb:I

    invoke-direct {v11, v9, v2, v12}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreference;-><init>(Landroid/content/Context;Landroid/os/storage/VolumeInfo;I)V
    ...
    iget-object v2, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;
    ...
    iget-object v8, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;
    ...
    .line 177
    sget v10, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xb:I
    ...
    invoke-virtual {v0, v6}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v2}, Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 204
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xf:Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;
    ...
    invoke-virtual {v0, v3, v6}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wn:Landroid/preference/PreferenceCategory;
    ...
    iget-object v3, v0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xe:Landroid/preference/PreferenceCategory;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->a(Landroid/app/Fragment;Ljava/lang/String;IILandroid/os/Bundle;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;

    .line 106
    iget-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;

    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wl:Landroid/os/storage/StorageEventListener;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->addPreferencesFromResource(I)V

    .line 110
    const-string v0, "storage_internal"

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/preference/PreferenceCategory;

    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wn:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xe:Landroid/preference/PreferenceCategory;

    .line 113
    new-instance v0, Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;

    invoke-direct {v0, v1}, Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Xf:Lcom/android/settings_ex/deviceinfo/StorageSummaryPreference;

    .line 115
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->setHasOptionsMenu(Z)V
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Wl:Landroid/os/storage/StorageEventListener;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 246
    instance-of v1, p2, Lcom/android/settings_ex/deviceinfo/StorageVolumePreference;

    if-eqz v1, :cond_5

    .line 248
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/StorageSettings;->Vt:Landroid/os/storage/StorageManager;
    ...
    invoke-static {p0, v0}, Lcom/android/settings_ex/deviceinfo/StorageSettings$VolumeUnmountedFragment;->b(Landroid/app/Fragment;Ljava/lang/String;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/android/settings_ex/deviceinfo/StorageSettings$DiskInitFragment;->a(Landroid/app/Fragment;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/settings_ex/deviceinfo/StorageSettings;->a(Landroid/app/Fragment;Ljava/lang/String;IILandroid/os/Bundle;)Z
