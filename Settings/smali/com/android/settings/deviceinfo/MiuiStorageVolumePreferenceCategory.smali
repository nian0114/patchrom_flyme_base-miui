...
.method private constructor <init>(Landroid/content/Context;Landroid/os/storage/VolumeInfo;Landroid/os/storage/DiskInfo;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vr:Z

    .line 73
    iput-object p2, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vs:Landroid/os/storage/VolumeInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vt:Landroid/os/storage/StorageManager;

    .line 76
    iput-object p3, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vx:Landroid/os/storage/DiskInfo;

    .line 77
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vx:Landroid/os/storage/DiskInfo;
...
.method private b(JJ)V
    ...
    .line 229
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vz:J

    .line 230
    sub-long v0, p1, p3

    .line 231
    iget-object v2, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vu:Lcom/android/settings/deviceinfo/UsageBarPreference;

    invoke-virtual {v2}, Lcom/android/settings/deviceinfo/UsageBarPreference;->clear()V

    .line 232
    iget-wide v2, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vz:J
    ...
    .line 234
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vu:Lcom/android/settings/deviceinfo/UsageBarPreference;
...
.method private pa()V
    ...
    .line 146
    .line 148
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vs:Landroid/os/storage/VolumeInfo;
    ...
    .line 152
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vv:Landroid/preference/Preference;
    ...
    .line 157
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vr:Z
    ...
    .line 165
    :goto_0
    iget-object v3, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vv:Landroid/preference/Preference;

    invoke-virtual {v3, v1}, Landroid/preference/Preference;->setTitle(I)V

    .line 166
    iget-object v1, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vv:Landroid/preference/Preference;
    ...
    :cond_1
    :goto_1
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->ux:Z

    if-eqz v0, :cond_c

    const-string v0, "mtp"

    iget-object v1, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vy:Ljava/lang/String;
    ...
    .line 212
    :cond_4
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vw:Landroid/preference/Preference;
...
.method public init()V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vu:Lcom/android/settings/deviceinfo/UsageBarPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vv:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vw:Landroid/preference/Preference;
    ...
    .line 127
    :goto_1
    iget-object v2, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vw:Landroid/preference/Preference;

    invoke-virtual {v2, v1}, Landroid/preference/Preference;->setTitle(I)V

    .line 128
    iget-object v1, p0, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->Vw:Landroid/preference/Preference;
    ...
    .line 139
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/MiuiStorageVolumePreferenceCategory;->pa()V
