...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->XA:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageWizardInit;)Landroid/widget/RadioButton;
    ...
    .prologue
    .line 31
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xy:Landroid/widget/RadioButton;
...
.method static synthetic b(Lcom/android/settings/deviceinfo/StorageWizardInit;)Landroid/widget/RadioButton;
    ...
    .prologue
    .line 31
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xz:Landroid/widget/RadioButton;
...
.method public ia()V
    ...
    .line 102
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vs:Landroid/os/storage/VolumeInfo;
    ...
    .line 105
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vk:Landroid/os/storage/StorageManager;

    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vs:Landroid/os/storage/VolumeInfo;
    ...
    iget-object v2, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vx:Landroid/os/storage/DiskInfo;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 40
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vx:Landroid/os/storage/DiskInfo;
    ...
    :goto_1
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->WD:Z
    ...
    iget-object v4, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Vx:Landroid/os/storage/DiskInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xy:Landroid/widget/RadioButton;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xz:Landroid/widget/RadioButton;

    .line 55
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xy:Landroid/widget/RadioButton;

    iget-object v3, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->XA:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iget-object v3, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xy:Landroid/widget/RadioButton;

    invoke-virtual {v3}, Landroid/widget/RadioButton;->getCompoundPaddingLeft()I

    move-result v3

    iget-object v4, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->Xy:Landroid/widget/RadioButton;
    ...
    .line 72
    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/StorageWizardInit;->ia()V

    .line 73
    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/StorageWizardInit;->finish()V

    .line 78
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageWizardInit;->WD:Z
