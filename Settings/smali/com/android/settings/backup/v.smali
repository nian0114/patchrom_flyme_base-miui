...
.field private Qe:Lcom/android/settings/backup/j;

.field final synthetic Qf:Lcom/android/settings/backup/t;
...
.method private constructor <init>(Lcom/android/settings/backup/t;)V
    ...
    .prologue
    .line 181
    iput-object p1, p0, Lcom/android/settings/backup/v;->Qf:Lcom/android/settings/backup/t;
...
.method public a(Landroid/os/ParcelFileDescriptor;)I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->Qf:Lcom/android/settings/backup/t;

    iget-object v1, v1, Lcom/android/settings/backup/t;->PN:Lmiui/app/backup/FullBackupAgent;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->PA:Ljava/io/File;

    .line 188
    iget-object v0, p0, Lcom/android/settings/backup/v;->PA:Ljava/io/File;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;
    ...
    .line 194
    iget-object v0, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;

    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lN()Ljava/util/Vector;

    move-result-object v0

    .line 195
    iget-object v2, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;

    invoke-virtual {v2}, Lcom/android/settings/backup/j;->lO()Ljava/util/Vector;

    move-result-object v2

    .line 196
    iget-object v3, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;

    invoke-virtual {v3}, Lcom/android/settings/backup/j;->lM()Ljava/util/Vector;
    ...
    .line 199
    :try_start_0
    iget-object v5, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;
    ...
    .line 209
    :try_start_1
    iget-object v4, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;
    ...
    .line 220
    :cond_5
    invoke-static {}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->nd()Lcom/android/settings/backup/y;

    move-result-object v0

    .line 221
    invoke-virtual {v1}, Lcom/android/settings/backup/p;->mH()Lcom/android/settings/backup/SettingProtos$Settings;
    ...
    .line 225
    :try_start_3
    invoke-virtual {v0}, Lcom/android/settings/backup/y;->nj()Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
    ...
    .line 233
    :cond_6
    sget-object v1, Lcom/android/settings/backup/h;->PO:[Lcom/android/settings/backup/A;
    ...
    .line 234
    iget-object v4, p0, Lcom/android/settings/backup/v;->Qf:Lcom/android/settings/backup/t;

    iget-object v4, v4, Lcom/android/settings/backup/t;->PN:Lmiui/app/backup/FullBackupAgent;

    iget-object v3, v3, Lcom/android/settings/backup/A;->Qj:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/backup/v;->PA:Ljava/io/File;
    ...
    .line 245
    iget-object v0, p0, Lcom/android/settings/backup/v;->Qf:Lcom/android/settings/backup/t;

    iget-object v0, v0, Lcom/android/settings/backup/t;->PN:Lmiui/app/backup/FullBackupAgent;
...
.method public a(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;)I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->PA:Ljava/io/File;
    ...
    :cond_2
    :try_start_6
    iget-object v2, p0, Lcom/android/settings/backup/v;->PV:Ljava/util/HashMap;
...
.method public b(Landroid/os/ParcelFileDescriptor;)I
    ...
    .line 271
    invoke-virtual {v0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->nc()Lcom/android/settings/backup/SettingProtos$Settings;
    :try_end_1
    ...
    :cond_4
    :try_start_5
    invoke-virtual {v2}, Lcom/android/settings/backup/SettingProtos$Settings;->mz()Ljava/util/List;
    ...
    .line 290
    :cond_5
    invoke-virtual {v2}, Lcom/android/settings/backup/SettingProtos$Settings;->mA()Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/backup/v;->PV:Ljava/util/HashMap;
...
.method public mY()I
    ...
    iget-object v1, p0, Lcom/android/settings/backup/v;->PV:Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lP()V

    .line 352
    iget-object v0, p0, Lcom/android/settings/backup/v;->Qe:Lcom/android/settings/backup/j;

    invoke-virtual {v0}, Lcom/android/settings/backup/j;->lQ()V
