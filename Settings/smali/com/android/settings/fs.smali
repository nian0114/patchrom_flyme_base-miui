...
.method public constructor <init>(Landroid/app/Activity;Ljava/util/List;Lcom/android/settings/accounts/AuthenticatorHelper;Z)V
    ...
    .line 694
    iput-object p3, p0, Lcom/android/settings/fs;->tr:Lcom/android/settings/accounts/AuthenticatorHelper;
    ...
    iput-object v0, p0, Lcom/android/settings/fs;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v0, p0, Lcom/android/settings/fs;->tp:Ljava/util/HashMap;

    .line 697
    iget-object v0, p0, Lcom/android/settings/fs;->tp:Ljava/util/HashMap;
    ...
    invoke-virtual {p0}, Lcom/android/settings/fs;->getContext()Landroid/content/Context;
    ...
    .line 698
    iput-boolean p4, p0, Lcom/android/settings/fs;->tt:Z
    ...
    iput-object v0, p0, Lcom/android/settings/fs;->tq:Ljava/util/HashMap;

    .line 701
    iget-object v0, p0, Lcom/android/settings/fs;->tq:Ljava/util/HashMap;
    ...
    invoke-direct {v2, p1, v5}, Lcom/android/settings/wifi/aD;-><init>(Landroid/content/Context;Landroid/widget/TextView;)V
    ...
    invoke-direct {v2, p1, v5}, Lcom/android/settings/wifi/V;-><init>(Landroid/content/Context;Landroid/widget/TextView;)V
...
.method private a(Lcom/android/settings/ft;Landroid/preference/PreferenceActivity$Header;)V
    .locals 5
    ...
    .line 865
    :cond_2
    iget-object v0, p1, Lcom/android/settings/ft;->title:Landroid/widget/TextView;

    invoke-virtual {v0, v4}, Landroid/widget/TextView;->setEnabled(Z)V

    .line 866
    iget-object v0, p1, Lcom/android/settings/ft;->summary:Landroid/widget/TextView;
...
.method private b(Landroid/preference/PreferenceActivity$Header;)I
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/fs;->k(J)Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/fs;->l(J)Z
...
.method public b(Lcom/android/settings/ft;Landroid/preference/PreferenceActivity$Header;)V
    .locals 3
    ...
    iget-object v0, p1, Lcom/android/settings/ft;->icon:Landroid/widget/ImageView;
    ...
    .line 892
    :cond_2
    iget-object v1, p0, Lcom/android/settings/fs;->tr:Lcom/android/settings/accounts/AuthenticatorHelper;
    ...
    .line 893
    iget-object v1, p1, Lcom/android/settings/ft;->icon:Landroid/widget/ImageView;
...
.method public getItemViewType(I)I
    ...
    .prologue
    .line 668
    invoke-virtual {p0, p1}, Lcom/android/settings/fs;->getItem(I)Ljava/lang/Object;
    ...
    .line 669
    invoke-direct {p0, v0}, Lcom/android/settings/fs;->b(Landroid/preference/PreferenceActivity$Header;)I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast v1, Lcom/android/settings/ft;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0, v3, v0}, Lcom/android/settings/fs;->b(Lcom/android/settings/ft;Landroid/preference/PreferenceActivity$Header;)V

    .line 836
    invoke-direct {p0, v3, v0}, Lcom/android/settings/fs;->a(Lcom/android/settings/ft;Landroid/preference/PreferenceActivity$Header;)V
    ...
    .line 721
    :cond_2
    new-instance v3, Lcom/android/settings/ft;

    invoke-direct {v3}, Lcom/android/settings/ft;-><init>()V

    .line 722
    packed-switch v4, :pswitch_data_1

    .line 756
    iget-object v1, p0, Lcom/android/settings/fs;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v1, v3, Lcom/android/settings/ft;->title:Landroid/widget/TextView;
    ...
    iput-object v1, v3, Lcom/android/settings/ft;->icon:Landroid/widget/ImageView;
    ...
    iput-object v1, v3, Lcom/android/settings/ft;->summary:Landroid/widget/TextView;
    ...
    .line 734
    iget-object v5, p0, Lcom/android/settings/fs;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v1, v3, Lcom/android/settings/ft;->tu:Lmiui/widget/SlidingButton;
    ...
    iput-object v1, v3, Lcom/android/settings/ft;->tv:Landroid/widget/TextView;

    goto/16 :goto_2

    .line 767
    :pswitch_3
    iget-object v1, v3, Lcom/android/settings/ft;->title:Landroid/widget/TextView;
    ...
    .line 785
    :pswitch_4
    iget-object v1, p0, Lcom/android/settings/fs;->tp:Ljava/util/HashMap;
    ...
    check-cast v1, Lcom/android/settings/ac;

    .line 786
    if-eqz v1, :cond_7

    .line 787
    iget-object v5, v3, Lcom/android/settings/ft;->title:Landroid/widget/TextView;

    invoke-virtual {v1, v5}, Lcom/android/settings/ac;->a(Landroid/widget/TextView;)V

    .line 788
    iget-object v5, v3, Lcom/android/settings/ft;->tu:Lmiui/widget/SlidingButton;

    invoke-virtual {v1, v5}, Lcom/android/settings/ac;->a(Lmiui/widget/SlidingButton;)V
    ...
    :cond_7
    :pswitch_5
    iget-object v1, p0, Lcom/android/settings/fs;->tq:Ljava/util/HashMap;
    ...
    check-cast v1, Lcom/android/settings/ag;

    .line 796
    if-eqz v1, :cond_8

    .line 797
    iget-object v5, v3, Lcom/android/settings/ft;->tv:Landroid/widget/TextView;

    invoke-virtual {v1, v5}, Lcom/android/settings/ag;->b(Landroid/widget/TextView;)V
    ...
    .line 817
    iget-object v5, v3, Lcom/android/settings/ft;->summary:Landroid/widget/TextView;
    ...
    .line 828
    :goto_5
    iget-object v2, v3, Lcom/android/settings/ft;->icon:Landroid/widget/ImageView;
    ...
    .line 831
    :cond_b
    invoke-direct {p0, p2}, Lcom/android/settings/fs;->d(Landroid/view/View;)V

    goto/16 :goto_1

    .line 820
    :cond_c
    iget-object v1, v3, Lcom/android/settings/ft;->summary:Landroid/widget/TextView;
...
.method public isEnabled(I)Z
    ...
    .prologue
    .line 679
    invoke-virtual {p0, p1}, Lcom/android/settings/fs;->getItemViewType(I)I
...
.method public pause()V
    ...
    .line 917
    invoke-virtual {v0}, Lcom/android/settings/ac;->pause()V
    ...
    .line 922
    invoke-virtual {v0}, Lcom/android/settings/ag;->pause()V
...
.method public resume()V
    ...
    .line 905
    invoke-virtual {v0}, Lcom/android/settings/ac;->resume()V
    ...
    .line 910
    invoke-virtual {v0}, Lcom/android/settings/ag;->resume()V
