...
.field private ahi:Lcom/android/settings/location/SettingsInjector;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/location/LocationSettings;->Cp:Z
...
.method static synthetic a(Lcom/android/settings/location/LocationSettings;)Lcom/android/settings/location/SettingsInjector;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahi:Lcom/android/settings/location/SettingsInjector;
...
.method private a(Landroid/content/Context;Landroid/preference/PreferenceScreen;Z)V
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahi:Lcom/android/settings/location/SettingsInjector;

    .line 277
    iget-object v2, p0, Lcom/android/settings/location/LocationSettings;->ahi:Lcom/android/settings/location/SettingsInjector;
...
.method private c(Landroid/preference/PreferenceScreen;)V
    ...
    invoke-static {v0}, Lcom/android/settings/iE;->b(Landroid/os/UserManager;)Landroid/os/UserHandle;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahe:Landroid/os/UserHandle;

    .line 239
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahe:Landroid/os/UserHandle;
    ...
    .line 248
    :cond_0
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahf:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahf:Landroid/preference/Preference;

    .line 251
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahf:Landroid/preference/Preference;
...
.method private hw()Landroid/preference/PreferenceScreen;
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahg:Landroid/preference/Preference;

    .line 194
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahg:Landroid/preference/Preference;

    new-instance v4, Lcom/android/settings/location/LocationSettings$2;

    invoke-direct {v4, p0, v0}, Lcom/android/settings/location/LocationSettings$2;-><init>(Lcom/android/settings/location/LocationSettings;Lcom/android/settings/hp;)V
    ...
    iput-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahh:Landroid/preference/PreferenceCategory;
    ...
    .line 209
    invoke-virtual {v1}, Lcom/android/settings/location/RecentLocationApps;->rN()Ljava/util/List;
    ...
    .line 211
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->ahh:Landroid/preference/PreferenceCategory;
    ...
    .line 225
    :goto_0
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->ahe:Landroid/os/UserHandle;
    ...
    iget-object v5, p0, Lcom/android/settings/location/LocationSettings;->ahe:Landroid/os/UserHandle;
    ...
    .line 231
    invoke-virtual {p0}, Lcom/android/settings/location/LocationSettings;->rL()V
...
.method public l(IZ)V
    ...
    .line 355
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->ahg:Landroid/preference/Preference;
    ...
    .line 356
    iget-object v3, p0, Lcom/android/settings/location/LocationSettings;->ahh:Landroid/preference/PreferenceCategory;

    invoke-virtual {v3, v0}, Landroid/preference/PreferenceCategory;->setEnabled(Z)V

    .line 358
    iget-object v3, p0, Lcom/android/settings/location/LocationSettings;->ta:Landroid/widget/Switch;
    ...
    .line 360
    iget-boolean v3, p0, Lcom/android/settings/location/LocationSettings;->Cp:Z
    ...
    .line 369
    :cond_1
    iget-object v3, p0, Lcom/android/settings/location/LocationSettings;->ahf:Landroid/preference/Preference;
    ...
    .line 333
    :pswitch_0
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->ahg:Landroid/preference/Preference;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/hp;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/android/settings/location/LocationSettings;->ta:Landroid/widget/Switch;
...
.method public onPause()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lcom/android/settings/location/LocationSettings;->Cp:Z
...
.method public onResume()V
    ...
    .line 144
    invoke-direct {p0}, Lcom/android/settings/location/LocationSettings;->hw()Landroid/preference/PreferenceScreen;
