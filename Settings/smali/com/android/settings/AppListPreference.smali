...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/AppListPreference;->aW:Z
...
.method protected J()Landroid/widget/ListAdapter;
    ...
    iget-boolean v0, p0, Lcom/android/settings_ex/AppListPreference;->aW:Z
    ...
    iget-object v5, p0, Lcom/android/settings_ex/AppListPreference;->aV:[Landroid/graphics/drawable/Drawable;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Lcom/android/settings_ex/B;-><init>(Lcom/android/settings_ex/AppListPreference;Landroid/content/Context;I[Ljava/lang/CharSequence;[Landroid/graphics/drawable/Drawable;I)V
...
.method public a([Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/AppListPreference;->setEntries([Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/AppListPreference;->setEntryValues([Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/AppListPreference;->aV:[Landroid/graphics/drawable/Drawable;

    .line 127
    if-eq v2, v3, :cond_4

    .line 128
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/AppListPreference;->setValueIndex(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/AppListPreference;->setValue(Ljava/lang/String;)V
...
.method public e(Z)V
    ...
    .prologue
    .line 89
    iput-boolean p1, p0, Lcom/android/settings_ex/AppListPreference;->aW:Z
...
.method protected onPrepareDialogBuilder(Landroid/app/AlertDialog$Builder;)V
    ...
    .prologue
    .line 145
    invoke-virtual {p0}, Lcom/android/settings_ex/AppListPreference;->J()Landroid/widget/ListAdapter;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 157
    instance-of v0, p1, Lcom/android/settings_ex/AppListPreference$SavedState;

    if-eqz v0, :cond_0

    .line 158
    check-cast p1, Lcom/android/settings_ex/AppListPreference$SavedState;

    .line 159
    iget-boolean v0, p1, Lcom/android/settings_ex/AppListPreference$SavedState;->bc:Z

    iput-boolean v0, p0, Lcom/android/settings_ex/AppListPreference;->aW:Z

    .line 160
    iget-object v0, p1, Lcom/android/settings_ex/AppListPreference$SavedState;->ba:[Ljava/lang/CharSequence;

    iget-object v1, p1, Lcom/android/settings_ex/AppListPreference$SavedState;->bb:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0, v1}, Lcom/android/settings_ex/AppListPreference;->a([Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V

    .line 161
    iget-object v0, p1, Lcom/android/settings_ex/AppListPreference$SavedState;->bd:Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-boolean v4, p0, Lcom/android/settings_ex/AppListPreference;->aW:Z
