...
.field private final zp:Lcom/android/settings/search/b;
...
.field private zy:Lcom/android/settings/dashboard/e;
...
.method static constructor <clinit>()V
    ...
    .line 265
    sput-boolean v3, Lcom/android/settings/hp;->zg:Z
    ...
    sput-object v0, Lcom/android/settings/hp;->zk:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/hp;->zl:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->td:[I

    .line 385
    iput-boolean v2, p0, Lcom/android/settings/hp;->zn:Z

    .line 386
    new-instance v0, Lcom/android/settings/hq;

    invoke-direct {v0, p0}, Lcom/android/settings/hq;-><init>(Lcom/android/settings/hp;)V

    iput-object v0, p0, Lcom/android/settings/hp;->zo:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zp:Lcom/android/settings/search/b;

    .line 419
    iput-boolean v1, p0, Lcom/android/settings/hp;->zx:Z
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->mCategories:Ljava/util/ArrayList;

    .line 428
    new-instance v0, Lcom/android/settings/hr;

    invoke-direct {v0, p0}, Lcom/android/settings/hr;-><init>(Lcom/android/settings/hp;)V

    iput-object v0, p0, Lcom/android/settings/hp;->mHandler:Landroid/os/Handler;

    .line 442
    iput-boolean v1, p0, Lcom/android/settings/hp;->zA:Z

    .line 443
    iput v2, p0, Lcom/android/settings/hp;->zB:I
...
.method private W(Z)V
    ...
    .line 483
    iget-object v0, p0, Lcom/android/settings/hp;->mHandler:Landroid/os/Handler;
...
.method private a(Ljava/lang/String;Landroid/os/Bundle;ZZILjava/lang/CharSequence;Z)Landroid/app/Fragment;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/hp;->isValidFragment(Ljava/lang/String;)Z
    ...
    .line 1111
    invoke-virtual {p0}, Lcom/android/settings/hp;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    .line 1114
    iget-object v2, p0, Lcom/android/settings/hp;->zu:Landroid/view/ViewGroup;
...
.method public static a(ILjava/util/List;Landroid/content/Context;)V
    ...
    invoke-static {p2}, Lcom/android/settings/iE;->ag(Landroid/content/Context;)Z
    ...
    .line 1286
    invoke-virtual {v4}, Lcom/android/settings/dashboard/DashboardCategory;->oQ()I

    move-result v6

    iput v6, v4, Lcom/android/settings/dashboard/DashboardCategory;->UF:I
...
.method private a(Landroid/app/FragmentManager$BackStackEntry;)V
    ...
    .line 839
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->getText(I)Ljava/lang/CharSequence;
    ...
    .line 844
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->setTitle(Ljava/lang/CharSequence;)V
...
.method static synthetic a(Lcom/android/settings/hp;Ljava/util/List;)V
    .locals 0

    .prologue
    .line 149
    invoke-direct {p0, p1}, Lcom/android/settings/hp;->n(Ljava/util/List;)V
...
.method private a(Ljava/util/List;Landroid/os/UserHandle;Ljava/util/Map;)V
    ...
    .prologue
    .line 1419
    invoke-virtual {p0}, Lcom/android/settings/hp;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    .line 1437
    invoke-direct {p0, p1, v3}, Lcom/android/settings/hp;->a(Ljava/util/List;Ljava/lang/String;)Lcom/android/settings/dashboard/DashboardCategory;
    ...
    .line 1450
    invoke-static {p0, v0}, Lcom/android/settings/iE;->a(Landroid/content/Context;Lcom/android/settings/dashboard/DashboardTile;)Z

    .line 1452
    iget v2, v4, Lcom/android/settings/dashboard/DashboardCategory;->UF:I
...
.method private a(Lcom/android/settings/dashboard/DashboardTile;)Z
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/settings/hp;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0}, Lcom/android/settings/hp;->hG()I

    move-result v3

    iput v3, p0, Lcom/android/settings/hp;->zB:I

    .line 1483
    iget v3, p0, Lcom/android/settings/hp;->zB:I
    ...
    .line 1488
    sget-boolean v3, Lcom/android/settings/hp;->zg:Z
...
.method static synthetic a(Lcom/android/settings/hp;)Z
    .locals 1

    .prologue
    .line 149
    iget-boolean v0, p0, Lcom/android/settings/hp;->zn:Z

    return v0
.end method

.method static synthetic a(Lcom/android/settings/hp;Z)Z
    .locals 0

    .prologue
    .line 149
    iput-boolean p1, p0, Lcom/android/settings/hp;->zn:Z

    return p1
.end method

.method static synthetic b(Lcom/android/settings/hp;)Ljava/util/ArrayList;
    .locals 1

    .prologue
    .line 149
    iget-object v0, p0, Lcom/android/settings/hp;->mCategories:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic b(Lcom/android/settings/hp;Z)V
    .locals 0

    .prologue
    .line 149
    invoke-direct {p0, p1}, Lcom/android/settings/hp;->W(Z)V
...
.method private hH()I
    ...
    .line 821
    iget v0, p0, Lcom/android/settings/hp;->zj:I
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->setTitle(I)V
    ...
    .line 824
    :cond_0
    iget-object v0, p0, Lcom/android/settings/hp;->zi:Ljava/lang/CharSequence;
    ...
    .line 830
    invoke-direct {p0, v1}, Lcom/android/settings/hp;->a(Landroid/app/FragmentManager$BackStackEntry;)V
...
.method private hI()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/hp;->getComponentName()Landroid/content/ComponentName;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zh:Ljava/lang/String;
    :try_end_0
...
.method public static hJ()V
    ...
    sput-boolean v0, Lcom/android/settings/hp;->zg:Z
...
.method private hK()V
    ...
    .line 1581
    iget-object v0, p0, Lcom/android/settings/hp;->zy:Lcom/android/settings/dashboard/e;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zy:Lcom/android/settings/dashboard/e;

    .line 1592
    :goto_1
    iget-object v0, p0, Lcom/android/settings/hp;->zy:Lcom/android/settings/dashboard/e;

    iget-object v1, p0, Lcom/android/settings/hp;->zv:Landroid/widget/SearchView;

    invoke-virtual {v0, v1}, Lcom/android/settings/dashboard/e;->setSearchView(Landroid/widget/SearchView;)V

    .line 1593
    iput-boolean v4, p0, Lcom/android/settings/hp;->zx:Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/settings/hp;->a(Ljava/lang/String;Landroid/os/Bundle;ZZILjava/lang/CharSequence;Z)Landroid/app/Fragment;
...
.method private hM()V
    ...
    .line 1606
    iget-object v0, p0, Lcom/android/settings/hp;->zw:Landroid/view/MenuItem;
...
.method private static j(Landroid/content/Intent;)Z
    ...
    .line 555
    :goto_1
    sget-object v3, Lcom/android/settings/hp;->zl:[Ljava/lang/String;
...
.method private k(Landroid/content/Intent;)V
    ...
    iput-object v1, p0, Lcom/android/settings/hp;->zi:Ljava/lang/CharSequence;

    .line 786
    iput v0, p0, Lcom/android/settings/hp;->zj:I
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/settings/hp;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    iget v2, p0, Lcom/android/settings/hp;->zj:I
    ...
    .line 795
    iget-object v1, p0, Lcom/android/settings/hp;->zi:Ljava/lang/CharSequence;

    invoke-virtual {p0, v1}, Lcom/android/settings/hp;->setTitle(Ljava/lang/CharSequence;)V

    .line 796
    const/4 v1, -0x1

    iput v1, p0, Lcom/android/settings/hp;->zj:I
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_1
    iput-object v0, p0, Lcom/android/settings/hp;->zi:Ljava/lang/CharSequence;
    ...
    .line 807
    :cond_2
    invoke-virtual {p0}, Lcom/android/settings/hp;->getTitle()Ljava/lang/CharSequence;
...
.method private l(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .prologue
    .line 965
    iget-object v0, p0, Lcom/android/settings/hp;->zh:Ljava/lang/String;
...
.method private n(Ljava/util/List;)V
    ...
    invoke-static {v0, p1, p0}, Lcom/android/settings/hp;->a(ILjava/util/List;Landroid/content/Context;)V

    .line 1137
    invoke-direct {p0, p1}, Lcom/android/settings/hp;->o(Ljava/util/List;)V
...
.method private o(Ljava/util/List;)V
    ...
    .line 1308
    iget-object v0, p0, Lcom/android/settings/hp;->vC:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1321
    invoke-virtual {v1}, Lcom/android/settings/dashboard/DashboardCategory;->oQ()I
    ...
    .line 1328
    :cond_0
    invoke-static {p0, v2}, Lcom/android/settings/iE;->a(Landroid/content/Context;Lcom/android/settings/dashboard/DashboardTile;)Z
    ...
    iget-object v10, p0, Lcom/android/settings/hp;->td:[I
    ...
    .line 1349
    iget-boolean v2, p0, Lcom/android/settings/hp;->zn:Z
    ...
    .line 1353
    invoke-direct {p0, v2}, Lcom/android/settings/hp;->a(Lcom/android/settings/dashboard/DashboardTile;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/hp;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1401
    :cond_12
    invoke-direct {p0, p1}, Lcom/android/settings/hp;->p(Ljava/util/List;)V
...
.method private p(Ljava/util/List;)V
    ...
    .prologue
    .line 1405
    invoke-virtual {p0}, Lcom/android/settings/hp;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 1413
    invoke-direct {p0, p1, v0, v1}, Lcom/android/settings/hp;->a(Ljava/util/List;Landroid/os/UserHandle;Ljava/util/Map;)V
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;Landroid/os/UserHandle;)V
    ...
    .line 1052
    :goto_1
    iget-boolean v5, p0, Lcom/android/settings/hp;->zt:Z
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/settings/iE;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;ZLandroid/os/UserHandle;)V
...
.method public finishPreferencePanel(Landroid/app/Fragment;ILandroid/content/Intent;)V
    ...
    .prologue
    .line 1067
    invoke-virtual {p0, p2, p3}, Lcom/android/settings/hp;->setResult(ILandroid/content/Intent;)V

    .line 1068
    invoke-virtual {p0}, Lcom/android/settings/hp;->finish()V
...
.method public getIntent()Landroid/content/Intent;
    ...
    .line 941
    invoke-direct {p0, v2}, Lcom/android/settings/hp;->l(Landroid/content/Intent;)Ljava/lang/String;
...
.method public getNextButton()Landroid/widget/Button;
    ...
    .prologue
    .line 1529
    iget-object v0, p0, Lcom/android/settings/hp;->dZ:Landroid/widget/Button;

    return-object v0
.end method

.method public hF()Lcom/android/settings/widget/SwitchBar;
    .locals 1

    .prologue
    .line 448
    iget-object v0, p0, Lcom/android/settings/hp;->me:Lcom/android/settings/widget/SwitchBar;
...
.method public hL()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/hp;->zA:Z
...
.method public hN()Landroid/content/Intent;
    ...
    .prologue
    .line 1612
    iget-object v0, p0, Lcom/android/settings/hp;->zC:Landroid/content/Intent;
...
.method protected isValidFragment(Ljava/lang/String;)Z
    ...
    :goto_0
    sget-object v1, Lcom/android/settings/hp;->zk:[Ljava/lang/String;
...
.method public m(Landroid/content/Intent;)V
    ...
    .prologue
    .line 1616
    iput-object p1, p0, Lcom/android/settings/hp;->zC:Landroid/content/Intent;
...
.method public onBackStackChanged()V
    ...
    .prologue
    .line 814
    invoke-direct {p0}, Lcom/android/settings/hp;->hH()I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 564
    invoke-direct {p0}, Lcom/android/settings/hp;->hI()V

    .line 566
    invoke-virtual {p0}, Lcom/android/settings/hp;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->setTheme(I)V
    ...
    .line 587
    invoke-virtual {p0}, Lcom/android/settings/hp;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/settings/hp;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/hp;->vC:Landroid/content/SharedPreferences;

    .line 597
    invoke-static {v8}, Lcom/android/settings/hp;->i(Landroid/content/Intent;)Z

    move-result v0

    if-nez v0, :cond_3

    invoke-static {v8}, Lcom/android/settings/hp;->j(Landroid/content/Intent;)Z
    ...
    :goto_2
    iput-boolean v0, p0, Lcom/android/settings/hp;->zt:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/hp;->zs:Z
    ...
    .line 606
    iput-boolean v4, p0, Lcom/android/settings/hp;->zs:Z
    ...
    .line 619
    invoke-virtual {p0}, Lcom/android/settings/hp;->getThemeResId()I
    ...
    .line 627
    :cond_6
    iget-boolean v0, p0, Lcom/android/settings/hp;->zs:Z
    ...
    :goto_4
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->setContentView(I)V

    .line 631
    const v0, 0x7f1302a9

    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/view/ViewGroup;

    iput-object v0, p0, Lcom/android/settings/hp;->zu:Landroid/view/ViewGroup;
    ...
    .line 637
    invoke-static {p0}, Lcom/android/settings/iE;->ah(Landroid/content/Context;)Z
    ...
    .line 638
    invoke-virtual {p0}, Lcom/android/settings/hp;->getApplicationContext()Landroid/content/Context;
    ...
    iput-boolean v0, p0, Lcom/android/settings/hp;->zx:Z
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zz:Ljava/lang/String;

    .line 650
    invoke-direct {p0, v8}, Lcom/android/settings/hp;->k(Landroid/content/Intent;)V
    ...
    .line 655
    iget-object v1, p0, Lcom/android/settings/hp;->mCategories:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, Lcom/android/settings/hp;->zq:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/hp;->zr:Z
    ...
    iput v0, p0, Lcom/android/settings/hp;->zB:I

    .line 711
    :goto_6
    iput-boolean v4, p0, Lcom/android/settings/hp;->zr:Z
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->me:Lcom/android/settings/widget/SwitchBar;
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/hs;-><init>(Lcom/android/settings/hp;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/hp;->findViewById(I)Landroid/view/View;
    ...
    .line 734
    new-instance v2, Lcom/android/settings/ht;

    invoke-direct {v2, p0}, Lcom/android/settings/ht;-><init>(Lcom/android/settings/hp;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/hp;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/widget/Button;

    iput-object v2, p0, Lcom/android/settings/hp;->dZ:Landroid/widget/Button;

    .line 741
    iget-object v2, p0, Lcom/android/settings/hp;->dZ:Landroid/widget/Button;

    new-instance v3, Lcom/android/settings/hu;

    invoke-direct {v3, p0}, Lcom/android/settings/hu;-><init>(Lcom/android/settings/hp;)V
    ...
    .line 668
    iget-boolean v0, p0, Lcom/android/settings/hp;->zt:Z

    if-eqz v0, :cond_15

    .line 669
    iput-boolean v2, p0, Lcom/android/settings/hp;->zq:Z
    ...
    .line 684
    iget-object v1, p0, Lcom/android/settings/hp;->zh:Ljava/lang/String;

    .line 687
    :cond_14
    iget v5, p0, Lcom/android/settings/hp;->zj:I

    iget-object v6, p0, Lcom/android/settings/hp;->zi:Ljava/lang/CharSequence;
    ...
    .line 671
    iput-boolean v3, p0, Lcom/android/settings/hp;->zq:Z

    goto :goto_9

    .line 673
    :cond_16
    iput-boolean v4, p0, Lcom/android/settings/hp;->zq:Z
    ...
    .line 693
    iput-boolean v3, p0, Lcom/android/settings/hp;->zr:Z
    ...
    .line 699
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->startActivity(Landroid/content/Intent;)V
    ...
    .line 755
    :cond_18
    iget-object v3, p0, Lcom/android/settings/hp;->dZ:Landroid/widget/Button;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    .line 511
    iget-boolean v0, p0, Lcom/android/settings/hp;->zr:Z
    ...
    .line 515
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/hp;->getMenuInflater()Landroid/view/MenuInflater;
    ...
    .line 519
    iget-object v3, p0, Lcom/android/settings/hp;->zz:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zw:Landroid/view/MenuItem;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zv:Landroid/widget/SearchView;
    ...
    iget-object v0, p0, Lcom/android/settings/hp;->zv:Landroid/widget/SearchView;
    ...
    .line 537
    iget-boolean v0, p0, Lcom/android/settings/hp;->zx:Z
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/hp;->zm:Landroid/content/SharedPreferences$OnSharedPreferenceChangeListener;
    ...
    iput-object v0, p0, Lcom/android/settings/hp;->zm:Landroid/content/SharedPreferences$OnSharedPreferenceChangeListener;
...
.method public onMenuItemActionCollapse(Landroid/view/MenuItem;)Z
    ...
    iget-object v1, p0, Lcom/android/settings/hp;->zw:Landroid/view/MenuItem;
    ...
    .line 1574
    invoke-direct {p0}, Lcom/android/settings/hp;->hM()V
...
.method public onMenuItemActionExpand(Landroid/view/MenuItem;)Z
    ...
    .line 1565
    invoke-direct {p0}, Lcom/android/settings/hp;->hK()V
...
.method public onPause()V
    ...
    .line 913
    :cond_0
    iget-object v0, p0, Lcom/android/settings/hp;->zo:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
...
.method public onQueryTextChange(Ljava/lang/String;)Z
    ...
    .prologue
    .line 1550
    iput-object p1, p0, Lcom/android/settings/hp;->zz:Ljava/lang/String;
...
.method public onResume()V
    ...
    .line 883
    iget v1, p0, Lcom/android/settings/hp;->zB:I
    ...
    .line 885
    invoke-direct {p0, v2}, Lcom/android/settings/hp;->W(Z)V

    .line 888
    :cond_1
    new-instance v0, Lcom/android/settings/hv;

    invoke-direct {v0, p0}, Lcom/android/settings/hv;-><init>(Lcom/android/settings/hp;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/hp;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/android/settings/hp;->zz:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/hp;->onQueryTextSubmit(Ljava/lang/String;)Z
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/hp;->zq:Z
    ...
    iget-boolean v1, p0, Lcom/android/settings/hp;->zr:Z
...
.method protected onStart()V
    ...
    .line 504
    iget-boolean v0, p0, Lcom/android/settings/hp;->zA:Z
...
.method public shouldUpRecreateTask(Landroid/content/Intent;)Z
    ...
    const-class v1, Lcom/android/settings/hp;
...
.method public startPreferencePanel(Ljava/lang/String;Landroid/os/Bundle;ILjava/lang/CharSequence;Landroid/app/Fragment;I)V
    ...
    :cond_0
    :goto_0
    iget-boolean v7, p0, Lcom/android/settings/hp;->zt:Z
    ...
    invoke-static/range {v0 .. v7}, Lcom/android/settings/iE;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;IILjava/lang/CharSequence;Z)V
