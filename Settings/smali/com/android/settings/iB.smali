...
.method public constructor <init>(Landroid/os/UserHandle;Landroid/os/UserManager;Landroid/content/Context;)V
    ...
    .line 52
    iput-object p1, p0, Lcom/android/settings/iB;->BY:Landroid/os/UserHandle;

    .line 53
    iget-object v0, p0, Lcom/android/settings/iB;->BY:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/iB;->mName:Ljava/lang/String;
    ...
    .line 68
    :goto_0
    invoke-static {p3, v0}, Lcom/android/settings/iB;->a(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/iB;->mIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Lcom/android/settings/iB;->mName:Ljava/lang/String;
...
.method static synthetic b(Lcom/android/settings/iB;)Landroid/os/UserHandle;
    .locals 1
...
.method static synthetic c(Lcom/android/settings/iB;)Landroid/graphics/drawable/Drawable;
    .locals 1

    .prologue
    .line 46
    iget-object v0, p0, Lcom/android/settings/iB;->mIcon:Landroid/graphics/drawable/Drawable;
