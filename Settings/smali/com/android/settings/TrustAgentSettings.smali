...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/TrustAgentSettings;->Bm:Landroid/util/ArraySet;
...
.method private ip()V
    ...
    .line 92
    iget-object v0, p0, Lcom/android/settings/TrustAgentSettings;->Bl:Landroid/util/ArrayMap;

    if-nez v0, :cond_0

    .line 93
    invoke-virtual {p0}, Lcom/android/settings/TrustAgentSettings;->is()Landroid/util/ArrayMap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/TrustAgentSettings;->Bl:Landroid/util/ArrayMap;
    ...
    .line 98
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/TrustAgentSettings;->iq()V
    ...
    .line 106
    :goto_0
    iget-object v1, p0, Lcom/android/settings/TrustAgentSettings;->Bl:Landroid/util/ArrayMap;
    ...
    check-cast v1, Lcom/android/settings/ic;
    ...
    .line 110
    iput-object v7, v1, Lcom/android/settings/ic;->Bn:Landroid/preference/SwitchPreference;

    .line 111
    invoke-virtual {v7, v3}, Landroid/preference/SwitchPreference;->setPersistent(Z)V

    .line 112
    iget-object v8, v1, Lcom/android/settings/ic;->label:Ljava/lang/CharSequence;

    invoke-virtual {v7, v8}, Landroid/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 113
    iget-object v8, v1, Lcom/android/settings/ic;->icon:Landroid/graphics/drawable/Drawable;
    ...
    .line 116
    iget-object v8, p0, Lcom/android/settings/TrustAgentSettings;->Bm:Landroid/util/ArraySet;

    iget-object v9, v1, Lcom/android/settings/ic;->component:Landroid/content/ComponentName;
    ...
    .line 125
    :cond_2
    iget-object v1, v1, Lcom/android/settings/ic;->Bn:Landroid/preference/SwitchPreference;
...
.method private iq()V
    ...
    .line 133
    iget-object v1, p0, Lcom/android/settings/TrustAgentSettings;->Bm:Landroid/util/ArraySet;
...
.method is()Landroid/util/ArrayMap;
    ...
    .line 154
    :cond_1
    invoke-static {v0, v2}, Lcom/android/settings/id;->a(Landroid/content/pm/ResolveInfo;Landroid/content/pm/PackageManager;)Z
    ...
    .line 156
    new-instance v7, Lcom/android/settings/ic;

    invoke-direct {v7}, Lcom/android/settings/ic;-><init>()V
    ...
    iput-object v8, v7, Lcom/android/settings/ic;->label:Ljava/lang/CharSequence;
    ...
    iput-object v0, v7, Lcom/android/settings/ic;->icon:Landroid/graphics/drawable/Drawable;

    .line 159
    iput-object v6, v7, Lcom/android/settings/ic;->component:Landroid/content/ComponentName;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 171
    iget-object v4, v0, Lcom/android/settings/ic;->Bn:Landroid/preference/SwitchPreference;
    ...
    iget-object v2, v0, Lcom/android/settings/ic;->component:Landroid/content/ComponentName;
    ...
    iget-object v0, v0, Lcom/android/settings/ic;->component:Landroid/content/ComponentName;
    ...
    :cond_0
    :goto_1
    invoke-direct {p0}, Lcom/android/settings/TrustAgentSettings;->ir()V
