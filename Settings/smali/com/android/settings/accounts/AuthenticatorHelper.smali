...
.field private final Ew:Lcom/android/settings/accounts/AuthenticatorHelper$OnAccountsUpdateListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;Landroid/os/UserManager;Lcom/android/settings/accounts/AuthenticatorHelper$OnAccountsUpdateListener;)V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Er:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Et:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Eu:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ev:Ljava/util/HashMap;

    .line 73
    iput-object p1, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->mContext:Landroid/content/Context;

    .line 74
    iput-object p3, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->aN:Landroid/os/UserManager;

    .line 75
    iput-object p2, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->BY:Landroid/os/UserHandle;

    .line 76
    iput-object p4, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ew:Lcom/android/settings/accounts/AuthenticatorHelper$OnAccountsUpdateListener;
...
.method private jm()V
    ...
    .prologue
    .line 261
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ev:Ljava/util/HashMap;

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    .line 262
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->BY:Landroid/os/UserHandle;
    ...
    .line 269
    iget-object v5, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ev:Ljava/util/HashMap;
...
.method public ae(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 157
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Er:Ljava/util/Map;
...
.method public ai(Ljava/lang/String;)Z
    ...
    .prologue
    .line 199
    invoke-virtual {p0, p1}, Lcom/android/settings/accounts/AuthenticatorHelper;->ag(Ljava/lang/String;)Z
    ...
    .line 200
    invoke-virtual {p0, p1}, Lcom/android/settings/accounts/AuthenticatorHelper;->ah(Ljava/lang/String;)Landroid/accounts/AuthenticatorDescription;
...
.method public al(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->BY:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Es:[Landroid/accounts/AuthenticatorDescription;

    .line 185
    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Es:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 186
    iget-object v1, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Er:Ljava/util/Map;

    iget-object v2, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Es:[Landroid/accounts/AuthenticatorDescription;

    aget-object v2, v2, v0

    iget-object v2, v2, Landroid/accounts/AuthenticatorDescription;->type:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Es:[Landroid/accounts/AuthenticatorDescription;
...
.method public j(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 104
    iget-object v2, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Eu:Ljava/util/Map;

    monitor-enter v2

    .line 105
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Eu:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->BY:Landroid/os/UserHandle;
    ...
    iget-object v2, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->BY:Landroid/os/UserHandle;
...
.method public jf()V
    ...
    .line 238
    iget-boolean v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ex:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ex:Z
...
.method public jl()[Ljava/lang/String;
    ...
    .prologue
    .line 83
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Et:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Et:Ljava/util/ArrayList;
...
.method public onAccountsUpdated([Landroid/accounts/Account;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/accounts/AuthenticatorHelper;->al(Landroid/content/Context;)V
    ...
    .line 219
    iget-object v2, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Et:Ljava/util/ArrayList;
    ...
    .line 223
    :cond_2
    invoke-direct {p0}, Lcom/android/settings/accounts/AuthenticatorHelper;->jm()V
    ...
    .line 225
    iget-object v0, p0, Lcom/android/settings/accounts/AuthenticatorHelper;->Ew:Lcom/android/settings/accounts/AuthenticatorHelper$OnAccountsUpdateListener;
