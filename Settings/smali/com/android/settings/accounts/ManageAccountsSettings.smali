...
.field private EE:Landroid/accounts/Account;
...
.method private a(Lcom/android/settings_ex/i;)V
    .locals 7
    ...
    invoke-virtual {p1}, Lcom/android/settings_ex/i;->getAccount()Landroid/accounts/Account;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->BY:Landroid/os/UserHandle;
...
.method private a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    .line 565
    iget-object v1, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->tf:Lcom/android/settings_ex/accounts/AuthenticatorHelper;

    iget-object v2, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->ah(Ljava/lang/String;)Landroid/accounts/AuthenticatorDescription;
...
.method static synthetic a(Lcom/android/settings_ex/accounts/ManageAccountsSettings;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    .locals 1

    .prologue
    .line 69
    invoke-direct {p0, p1, p2}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
...
.method private ac(Z)V
    ...
    .line 234
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->BY:Landroid/os/UserHandle;
    ...
    .line 242
    instance-of v7, v0, Lcom/android/settings_ex/i;

    if-eqz v7, :cond_2

    .line 243
    check-cast v0, Lcom/android/settings_ex/i;

    invoke-virtual {v0}, Lcom/android/settings_ex/i;->getAccount()Landroid/accounts/Account;
...
.method private b(Landroid/preference/PreferenceScreen;)V
    ...
    const-class v4, Lcom/android/settings_ex/location/MiuiLocationSettings;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->BY:Landroid/os/UserHandle;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->EE:Landroid/accounts/Account;
    ...
    .line 530
    new-instance v3, Lcom/android/settings_ex/accounts/ManageAccountsSettings$1;

    invoke-direct {v3, p0, v1}, Lcom/android/settings_ex/accounts/ManageAccountsSettings$1;-><init>(Lcom/android/settings_ex/accounts/ManageAccountsSettings;Landroid/content/pm/PackageManager;)V
...
.method private jo()V
    ...
    iget-object v2, v0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->BY:Landroid/os/UserHandle;
    ...
    .line 299
    instance-of v3, v2, Lcom/android/settings_ex/i;
    ...
    .line 303
    :cond_5
    check-cast v2, Lcom/android/settings_ex/i;

    .line 304
    invoke-virtual {v2}, Lcom/android/settings_ex/i;->getAccount()Landroid/accounts/Account;
    ...
    .line 308
    invoke-virtual {v2}, Lcom/android/settings_ex/i;->i()Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v12, v1, v3}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(ILandroid/accounts/Account;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v13, v1, v3}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(Ljava/util/List;Landroid/accounts/Account;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/settings_ex/i;->a(IZ)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings_ex/i;->setSummary(Ljava/lang/CharSequence;)V
    ...
    iget-object v3, v0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->Ek:Landroid/widget/TextView;
    ...
    .line 361
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->invalidateOptionsMenu()V
...
.method private jp()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->EE:Landroid/accounts/Account;
    ...
    .line 398
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->aa(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v4

    .line 402
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->DS:[Ljava/lang/String;
    ...
    .line 404
    iget-object v1, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->DS:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->ab(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 420
    :cond_3
    new-instance v0, Lcom/android/settings_ex/accounts/XiaomiAccountPreference;

    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/settings_ex/accounts/XiaomiAccountPreference;-><init>(Landroid/content/Context;Landroid/accounts/Account;Landroid/graphics/drawable/Drawable;Ljava/util/ArrayList;)V
    ...
    .line 427
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->EE:Landroid/accounts/Account;

    if-nez v0, :cond_1

    .line 428
    iput-object v2, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->EE:Landroid/accounts/Account;

    .line 430
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->invalidateOptionsMenu()V
    ...
    .line 422
    :cond_5
    new-instance v0, Lcom/android/settings_ex/i;

    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct/range {v0 .. v5}, Lcom/android/settings_ex/i;-><init>(Landroid/content/Context;Landroid/accounts/Account;Landroid/graphics/drawable/Drawable;Ljava/util/ArrayList;Z)V
    ...
    .line 435
    invoke-direct {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->jq()V
...
.method private jq()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(Ljava/lang/String;Landroid/preference/PreferenceScreen;)Landroid/preference/PreferenceScreen;
    ...
    .line 445
    invoke-direct {p0, v0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->b(Landroid/preference/PreferenceScreen;)V
...
.method public a(Landroid/os/UserHandle;)V
    ...
    .prologue
    .line 384
    invoke-direct {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->jp()V

    .line 385
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->jc()V
...
.method protected jb()V
    ...
    .line 590
    instance-of v2, v0, Lcom/android/settings_ex/i;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->ac(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/android/settings_ex/i;->setSummary(Ljava/lang/CharSequence;)V
...
.method protected jc()V
    ...
    .prologue
    .line 264
    invoke-direct {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->jo()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->Ek:Landroid/widget/TextView;

    .line 144
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->Ek:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->DS:[Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 224
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->ac(Z)V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->ac(Z)V
...
.method public onPause()V
    ...
    .line 157
    iget-object v0, p0, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->tf:Lcom/android/settings_ex/accounts/AuthenticatorHelper;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 176
    instance-of v1, p2, Lcom/android/settings_ex/accounts/XiaomiAccountPreference;
    ...
    .line 178
    :cond_1
    instance-of v1, p2, Lcom/android/settings_ex/i;

    if-eqz v1, :cond_0

    .line 180
    check-cast p2, Lcom/android/settings_ex/i;

    invoke-direct {p0, p2}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->a(Lcom/android/settings_ex/i;)V
...
.method public onResume()V
    ...
    .line 120
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/ManageAccountsSettings;->jd()V
