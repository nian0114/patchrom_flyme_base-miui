...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EA:Ljava/util/ArrayList;

    .line 67
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ev:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Er:Ljava/util/Map;
...
.method private aj(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->BY:Landroid/os/UserHandle;
...
.method private jb()V
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Es:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 144
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->DS:[Ljava/lang/String;
    ...
    .line 146
    :goto_1
    iget-object v7, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->DS:[Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EB:Ljava/util/HashSet;
    ...
    .line 158
    iget-object v2, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EA:Ljava/util/ArrayList;
    ...
    .line 166
    :cond_4
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EA:Ljava/util/ArrayList;
    ...
    .line 171
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ez:Landroid/preference/PreferenceGroup;
    ...
    .line 181
    iget-object v3, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->DS:[Ljava/lang/String;
...
.method private jd()V
    ...
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->BY:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Es:[Landroid/accounts/AuthenticatorDescription;

    .line 128
    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Es:[Landroid/accounts/AuthenticatorDescription;
    ...
    .line 129
    iget-object v1, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Er:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Es:[Landroid/accounts/AuthenticatorDescription;
...
.method public aa(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 193
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ev:Ljava/util/HashMap;
    ...
    .line 195
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->BY:Landroid/os/UserHandle;
    ...
    .line 202
    iget-object v5, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ev:Ljava/util/HashMap;
...
.method protected ab(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 222
    iget-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Er:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->BY:Landroid/os/UserHandle;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->DS:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EB:Ljava/util/HashSet;
    ...
    .line 111
    iget-object v4, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->EB:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->Ez:Landroid/preference/PreferenceGroup;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/settings/iE;->a(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/accounts/ChooseAccountActivity;->BY:Landroid/os/UserHandle;

    .line 118
    invoke-direct {p0}, Lcom/android/settings/accounts/ChooseAccountActivity;->jd()V
