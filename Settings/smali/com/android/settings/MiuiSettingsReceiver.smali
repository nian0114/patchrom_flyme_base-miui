.class public Lcom/android/settings_ex/MiuiSettingsReceiver;
...
.method private A(Landroid/content/Context;)V
    ...
    .line 281
    invoke-virtual {v0, p1}, Lcom/android/settings_ex/fA;->K(Landroid/content/Context;)Z
    ...
    .line 282
    invoke-virtual {v0, p1, v1}, Lcom/android/settings_ex/fA;->e(Landroid/content/Context;Z)V

    .line 286
    :cond_0
    :try_start_0
    invoke-static {p1}, Lcom/android/settings_ex/b/a;->aW(Landroid/content/Context;)V
    :try_end_0
    ...
    :goto_1
    invoke-static {v0}, Lcom/android/settings_ex/fA;->O(Z)V

    .line 294
    invoke-static {p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->x(Landroid/content/Context;)V

    .line 297
    invoke-static {p1}, Lcom/android/settings_ex/display/d;->be(Landroid/content/Context;)V
    ...
    .line 300
    invoke-static {v1}, Lcom/android/settings_ex/dj;->z(Z)V
    ...
    invoke-static {v0, v3}, Lcom/android/settings_ex/fu;->a(Landroid/hardware/input/InputManager;I)V
    ...
    .line 328
    :cond_6
    invoke-static {p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->B(Landroid/content/Context;)V
...
.method private F(Landroid/content/Context;)V
    ...
    .line 472
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->G(Landroid/content/Context;)V
...
.method private G(Landroid/content/Context;)V
    ...
    .line 484
    invoke-static {p1}, Lcom/android/settings_ex/privacypassword/XiaomiAccountUtils;->cd(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lcom/android/settings_ex/privacypassword/XiaomiAccountUtils;->ce(Landroid/content/Context;)Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    const-class v1, Lcom/android/settings_ex/wifi/WifiConfigActivity;
...
.method private d(Landroid/content/Context;I)V
    ...
    .line 395
    invoke-static {p2}, Lcom/android/settings_ex/wifi/WifiTipActivity;->dP(I)Ljava/lang/String;
    ...
    const-class v1, Lcom/android/settings_ex/wifi/WifiTipActivity;
...
.method private static y(Landroid/content/Context;)V
    ...
    const-class v2, Lcom/android/settings_ex/wifi/MiuiWifiService;
...
.method private z(Landroid/content/Context;)V
    ...
    .line 271
    invoke-static {p1}, Lcom/android/settings_ex/wifi/e;->cv(Landroid/content/Context;)Lcom/android/settings_ex/wifi/e;

    move-result-object v0

    .line 272
    invoke-virtual {v0, p1, v1, v4}, Lcom/android/settings_ex/wifi/e;->a(Landroid/content/Context;Ljava/util/HashSet;Z)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 93
    invoke-static {p1}, Lcom/android/settings_ex/wifi/aC;->isWifiConnected(Landroid/content/Context;)Z
    ...
    .line 95
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->A(Landroid/content/Context;)V

    .line 96
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->E(Landroid/content/Context;)V

    .line 97
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->z(Landroid/content/Context;)V

    .line 98
    new-instance v0, Landroid/content/Intent;

    const-class v1, Lcom/android/settings_ex/analytics/ObserverService;
    ...
    const-class v1, Lcom/android/settings_ex/go;
    ...
    .line 104
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->w(Landroid/content/Context;)V

    .line 105
    invoke-static {p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->y(Landroid/content/Context;)V
    ...
    .line 109
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->F(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/android/settings_ex/wifi/ak;->cz(Landroid/content/Context;)Z
    ...
    .line 118
    invoke-static {p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->C(Landroid/content/Context;)V
    ...
    .line 122
    :cond_7
    invoke-static {p1}, Lcom/android/settings_ex/display/F;->bl(Landroid/content/Context;)V
    ...
    .line 124
    invoke-static {p1, p2}, Lcom/android/settings_ex/MiuiSettingsReceiver;->c(Landroid/content/Context;Landroid/content/Intent;)V

    .line 125
    invoke-static {p1, p2}, Lcom/android/settings_ex/MiuiSettingsReceiver;->d(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 128
    invoke-static {p1, v0}, Lcom/android/settings_ex/MiuiSettingsReceiver;->a(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 133
    invoke-static {p1, v1}, Lcom/android/settings_ex/wifi/openwifi/l;->m(Landroid/content/Context;Z)V
    ...
    invoke-static {p1}, Lcom/android/settings_ex/n;->c(Landroid/content/Context;)Z
    ...
    .line 161
    invoke-direct {p0, p1, v3}, Lcom/android/settings_ex/MiuiSettingsReceiver;->d(Landroid/content/Context;I)V
    ...
    const-class v4, Lcom/android/settings_ex/wifi/MiuiWifiService;
    ...
    :goto_4
    invoke-static {p1, v2}, Lcom/android/settings_ex/wifi/openwifi/l;->m(Landroid/content/Context;Z)V
    ...
    .line 166
    invoke-direct {p0, p1, v2}, Lcom/android/settings_ex/MiuiSettingsReceiver;->d(Landroid/content/Context;I)V
    ...
    .line 181
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MiuiSettingsReceiver;->D(Landroid/content/Context;)V
    ...
    .line 187
    invoke-static {p1, v0}, Lcom/android/settings_ex/vpn2/VpnUtils;->p(Landroid/content/Context;Z)V
    ...
    invoke-static {v1}, Lcom/android/settings_ex/hf;->S(Landroid/content/Context;)Lcom/android/settings_ex/hf;

    move-result-object v1

    invoke-virtual {v1, p2}, Lcom/android/settings_ex/hf;->h(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/android/settings_ex/hf;->S(Landroid/content/Context;)Lcom/android/settings_ex/hf;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/settings_ex/hf;->hv()V
