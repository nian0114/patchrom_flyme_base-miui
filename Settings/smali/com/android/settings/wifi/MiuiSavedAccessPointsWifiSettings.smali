...
.method static synthetic a(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)Lcom/android/b/e/a;
    .locals 1

    .prologue
    .line 34
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAy:Lcom/android/b/e/a;
...
.method static synthetic a(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;Z)V
    ...
    .prologue
    .line 34
    invoke-direct {p0, p1}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->bC(Z)V
...
.method private b(Lcom/android/b/e/a;)V
    ...
    .prologue
    .line 136
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->je:Landroid/net/wifi/WifiManager;
    ...
    invoke-static {v0, v1}, Lcom/android/settings/wifi/ak;->i(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
...
.method static synthetic b(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)V
    ...
    .prologue
    .line 34
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->kY()V
...
.method private bC(Z)V
    ...
    .prologue
    .line 160
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAA:Ljava/util/List;
    ...
    .line 161
    invoke-virtual {v0, p1}, Lcom/android/settings/wifi/S;->bF(Z)V
...
.method private c(Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v0, v4}, Lcom/android/settings/wifi/S;-><init>(Lcom/android/b/e/a;Landroid/content/Context;)V

    .line 86
    iget-object v0, v0, Lcom/android/b/e/a;->ssid:Ljava/lang/String;

    invoke-virtual {v3, v0}, Lcom/android/settings/wifi/S;->setTitle(Ljava/lang/CharSequence;)V
...
.method static synthetic c(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)V
    ...
    .prologue
    .line 34
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->xg()V

    return-void
.end method

.method static synthetic d(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)V
    .locals 0

    .prologue
    .line 34
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->xh()V

    return-void
.end method

.method static synthetic e(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)Ljava/util/List;
    .locals 1
...
.method private kY()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAA:Ljava/util/List;
    ...
    .line 78
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->xf()V
...
.method private xf()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAz:Lmiui/widget/EditableListViewWrapper;

    .line 61
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAz:Lmiui/widget/EditableListViewWrapper;

    new-instance v1, Lcom/android/settings/wifi/m;

    invoke-direct {v1, p0}, Lcom/android/settings/wifi/m;-><init>(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)V
...
.method private xg()V
    ...
    .line 142
    invoke-virtual {v0}, Lcom/android/settings/wifi/S;->isChecked()Z
    ...
    .line 143
    invoke-virtual {v0}, Lcom/android/settings/wifi/S;->wR()Lcom/android/b/e/a;
...
.method private xh()V
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/wifi/S;->bG(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/wifi/S;->bG(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->je:Landroid/net/wifi/WifiManager;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 112
    instance-of v1, p2, Lcom/android/settings/wifi/S;
    ...
    iput-object v1, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAy:Lcom/android/b/e/a;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->aAy:Lcom/android/b/e/a;

    iget-object v5, v5, Lcom/android/b/e/a;->ssid:Ljava/lang/String;

    aput-object v5, v3, v4

    invoke-virtual {p0, v2, v3}, Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v3, p0}, Lcom/android/settings/wifi/l;-><init>(Lcom/android/settings/wifi/MiuiSavedAccessPointsWifiSettings;)V
