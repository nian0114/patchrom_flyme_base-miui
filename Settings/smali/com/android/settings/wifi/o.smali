...
# instance fields
.field final synthetic aAE:Lcom/android/settings/wifi/MiuiTetherDeviceSettings;
...
.method constructor <init>(Lcom/android/settings/wifi/MiuiTetherDeviceSettings;)V
    ...
    .prologue
    .line 32
    iput-object p1, p0, Lcom/android/settings/wifi/o;->aAE:Lcom/android/settings/wifi/MiuiTetherDeviceSettings;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lcom/android/settings/wifi/o;->aAE:Lcom/android/settings/wifi/MiuiTetherDeviceSettings;
    ...
    .line 36
    iget-object v1, p0, Lcom/android/settings/wifi/o;->aAE:Lcom/android/settings/wifi/MiuiTetherDeviceSettings;

    invoke-static {}, Lcom/android/settings/fA;->gi()Lcom/android/settings/fA;

    move-result-object v2

    iget-object v3, p0, Lcom/android/settings/wifi/o;->aAE:Lcom/android/settings/wifi/MiuiTetherDeviceSettings;

    invoke-virtual {v3}, Lcom/android/settings/wifi/MiuiTetherDeviceSettings;->getActivity()Landroid/app/Activity;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/android/settings/fA;->p(Landroid/content/Context;)Ljava/util/List;
