...
# instance fields
.field private final aAF:Lcom/android/settings/wifi/q;
...
.method public constructor <init>(Landroid/app/Activity;Landroid/view/View;Lcom/android/b/e/a;ZLcom/android/settings/wifi/q;)V
    ...
    .line 63
    iput-object p5, p0, Lcom/android/settings/wifi/p;->aAF:Lcom/android/settings/wifi/q;

    .line 65
    iput-object p2, p0, Lcom/android/settings/wifi/p;->mView:Landroid/view/View;

    .line 66
    iput-object p3, p0, Lcom/android/settings/wifi/p;->azR:Lcom/android/b/e/a;
    ...
    :goto_0
    iput v0, p0, Lcom/android/settings/wifi/p;->aCp:I

    .line 69
    iput-boolean p4, p0, Lcom/android/settings/wifi/p;->aAG:Z
    ...
    .line 73
    iget-object v0, p0, Lcom/android/settings/wifi/p;->azR:Lcom/android/b/e/a;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aDh:Landroid/widget/TextView;

    .line 75
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aDh:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCB:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCH:Landroid/widget/Spinner;
    ...
    .line 83
    iget-object v1, p0, Lcom/android/settings/wifi/p;->azR:Lcom/android/b/e/a;
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/p;->azR:Lcom/android/b/e/a;
    ...
    .line 117
    iget-object v1, p0, Lcom/android/settings/wifi/p;->aCB:Landroid/widget/Spinner;

    invoke-virtual {v1, v8}, Landroid/widget/Spinner;->setSelection(I)V

    .line 118
    iput-boolean v8, p0, Lcom/android/settings/wifi/p;->aAH:Z
    ...
    .line 123
    iget-object v1, p0, Lcom/android/settings/wifi/p;->aCH:Landroid/widget/Spinner;
    ...
    .line 137
    iget-object v5, p0, Lcom/android/settings/wifi/p;->azR:Lcom/android/b/e/a;
    ...
    .line 166
    :cond_7
    iget-boolean v0, p0, Lcom/android/settings/wifi/p;->aAG:Z
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCJ:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCK:Landroid/widget/TextView;

    .line 174
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCK:Landroid/widget/TextView;

    invoke-virtual {v0, p0}, Landroid/widget/TextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 176
    invoke-virtual {p0}, Lcom/android/settings/wifi/p;->yd()V

    .line 177
    invoke-virtual {p0}, Lcom/android/settings/wifi/p;->yc()V

    .line 179
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCB:Landroid/widget/Spinner;

    invoke-virtual {v0, p0}, Landroid/widget/Spinner;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 180
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCH:Landroid/widget/Spinner;
...
.method wZ()Landroid/net/wifi/WifiConfiguration;
    ...
    .line 254
    :goto_0
    iget-boolean v1, p0, Lcom/android/settings/wifi/p;->aAG:Z
...
.method xj()V
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/p;->aCq:Landroid/widget/TextView;

    if-eqz v3, :cond_2

    iget v3, p0, Lcom/android/settings/wifi/p;->aCp:I

    if-ne v3, v2, :cond_0

    iget-object v2, p0, Lcom/android/settings/wifi/p;->aCq:Landroid/widget/TextView;
    ...
    :cond_0
    iget v2, p0, Lcom/android/settings/wifi/p;->aCp:I
    ...
    .line 245
    invoke-virtual {p0}, Lcom/android/settings/wifi/p;->xk()Z

    move-result v0

    .line 247
    :cond_3
    iget-object v1, p0, Lcom/android/settings/wifi/p;->aAF:Lcom/android/settings/wifi/q;
...
.method protected xk()Z
    ...
    :goto_0
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCM:Landroid/net/IpConfiguration$IpAssignment;

    .line 264
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCM:Landroid/net/IpConfiguration$IpAssignment;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCP:Landroid/net/StaticIpConfiguration;

    .line 266
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCP:Landroid/net/StaticIpConfiguration;
    ...
    .line 273
    :goto_2
    iget-object v3, p0, Lcom/android/settings/wifi/p;->aCH:Landroid/widget/Spinner;
    ...
    iput-object v4, p0, Lcom/android/settings/wifi/p;->aCN:Landroid/net/IpConfiguration$ProxySettings;

    .line 275
    const/4 v4, 0x0

    iput-object v4, p0, Lcom/android/settings/wifi/p;->aCO:Landroid/net/ProxyInfo;

    .line 276
    if-ne v3, v1, :cond_6

    iget-object v4, p0, Lcom/android/settings/wifi/p;->aCI:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCN:Landroid/net/IpConfiguration$ProxySettings;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/p;->aCO:Landroid/net/ProxyInfo;
    ...
    :cond_4
    :goto_4
    iget-boolean v2, p0, Lcom/android/settings/wifi/p;->aAH:Z

    if-eqz v2, :cond_5

    iget-object v2, p0, Lcom/android/settings/wifi/p;->aCN:Landroid/net/IpConfiguration$ProxySettings;
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/p;->aCL:Landroid/widget/TextView;
    ...
    .line 297
    iget-object v0, p0, Lcom/android/settings/wifi/p;->aCL:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/settings/wifi/p;->aCO:Landroid/net/ProxyInfo;
