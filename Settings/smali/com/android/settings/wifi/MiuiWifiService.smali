...
# instance fields
.field private aAL:Lcom/android/settings/wifi/openwifi/l;

.field private aBa:Lcom/android/settings/wifi/ak;

.field private aBb:Landroid/os/HandlerThread;

.field private aBc:Lcom/android/settings/wifi/openwifi/o;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/wifi/MiuiWifiService;->aAZ:Landroid/net/Uri;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBe:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBf:Ljava/util/ArrayList;

    .line 154
    new-instance v0, Lcom/android/settings/wifi/F;

    invoke-direct {v0, p0}, Lcom/android/settings/wifi/F;-><init>(Lcom/android/settings/wifi/MiuiWifiService;)V
    ...
    iput v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBg:I
...
.method private B(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 315
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBe:Ljava/util/HashMap;

    monitor-enter v1

    .line 316
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBe:Ljava/util/HashMap;
...
.method private F(Landroid/content/Intent;)V
    ...
    .line 393
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aAL:Lcom/android/settings/wifi/openwifi/l;
...
.method static synthetic a(Lcom/android/settings/wifi/MiuiWifiService;)Lcom/android/settings/wifi/ak;
    .locals 1

    .prologue
    .line 71
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBa:Lcom/android/settings/wifi/ak;
...
.method private b(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 209
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->je:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {v2, p0, p1, v0}, Lcom/android/settings/fA;->a(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;I)V

    .line 229
    iget-object v2, p0, Lcom/android/settings/wifi/MiuiWifiService;->je:Landroid/net/wifi/WifiManager;
...
.method static synthetic b(Lcom/android/settings/wifi/MiuiWifiService;)V
    ...
    .prologue
    .line 71
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiWifiService;->xu()V
...
.method static synthetic c(Lcom/android/settings/wifi/MiuiWifiService;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBf:Ljava/util/ArrayList;
...
.method private c(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 308
    :cond_0
    invoke-direct {p0, p2}, Lcom/android/settings/wifi/MiuiWifiService;->b(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 310
    invoke-static {p2}, Lcom/android/settings/wifi/ak;->d(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;

    move-result-object v0

    .line 311
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBa:Lcom/android/settings/wifi/ak;

    invoke-virtual {v1, v0}, Lcom/android/settings/wifi/ak;->ch(Ljava/lang/String;)V

    goto :goto_0
.end method

.method static synthetic d(Lcom/android/settings/wifi/MiuiWifiService;)Landroid/widget/CheckBox;
    .locals 1

    .prologue
    .line 71
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->tb:Landroid/widget/CheckBox;
...
.method private xt()V
    ...
    .line 164
    iput-object v5, p0, Lcom/android/settings/wifi/MiuiWifiService;->aAL:Lcom/android/settings/wifi/openwifi/l;
    ...
    invoke-static {p0, v0}, Lcom/android/settings/wifi/j;->A(Landroid/content/Context;Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-virtual {v1, p0, v2, v3, v0}, Lcom/android/settings/wifi/ak;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;)V
...
.method private xu()V
    ...
    .line 240
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->je:Landroid/net/wifi/WifiManager;
    ...
    invoke-direct {p0, v2, v7}, Lcom/android/settings/wifi/MiuiWifiService;->B(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/wifi/MiuiWifiService;->bX(Ljava/lang/String;)V

    .line 257
    invoke-static {v1}, Lcom/android/settings/wifi/ak;->a(Landroid/net/wifi/ScanResult;)Ljava/lang/String;

    move-result-object v2

    .line 258
    invoke-static {v2}, Lcom/android/settings/wifi/ak;->ce(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-static {v1}, Lcom/android/settings/wifi/ak;->ce(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 263
    invoke-static {v1}, Lcom/android/settings/wifi/ak;->f(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 278
    invoke-static {v0}, Lcom/android/settings/wifi/ak;->a(Landroid/net/wifi/ScanResult;)Ljava/lang/String;

    move-result-object v3

    .line 279
    invoke-static {v3}, Lcom/android/settings/wifi/ak;->ce(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/MiuiWifiService;->bX(Ljava/lang/String;)V

    .line 300
    :cond_a
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBa:Lcom/android/settings/wifi/ak;

    invoke-virtual {v0, p0}, Lcom/android/settings/wifi/ak;->cx(Landroid/content/Context;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;ZLandroid/content/Intent;)V
    ...
    .line 450
    :cond_0
    invoke-static {p0, p1, p2}, Lcom/android/settings/wifi/openwifi/l;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/wifi/openwifi/l;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aAL:Lcom/android/settings/wifi/openwifi/l;
    ...
    invoke-static {v0}, Lcom/android/settings/wifi/openwifi/q;->cp(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p3}, Lcom/android/settings/wifi/openwifi/l;->h(Landroid/net/Uri;)V
    ...
    .line 467
    :cond_5
    invoke-virtual {p0}, Lcom/android/settings/wifi/MiuiWifiService;->xv()Z
    ...
    .line 468
    invoke-virtual {p0}, Lcom/android/settings/wifi/MiuiWifiService;->xw()V
...
.method public onCreate()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/wifi/ak;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBa:Lcom/android/settings/wifi/ak;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->je:Landroid/net/wifi/WifiManager;

    .line 91
    new-instance v0, Lcom/android/settings/wifi/openwifi/o;

    invoke-direct {v0, p0}, Lcom/android/settings/wifi/openwifi/o;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBc:Lcom/android/settings/wifi/openwifi/o;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBb:Landroid/os/HandlerThread;

    .line 93
    iget-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBb:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBb:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/settings/wifi/G;-><init>(Lcom/android/settings/wifi/MiuiWifiService;Landroid/os/Looper;)V
    ...
    invoke-static {p0, v0, v1}, Lcom/android/settings/wifi/openwifi/l;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/android/settings/wifi/openwifi/l;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 127
    invoke-direct {p0}, Lcom/android/settings/wifi/MiuiWifiService;->xt()V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/MiuiWifiService;->b(Landroid/net/wifi/WifiConfiguration;)V
...
.method public xv()Z
    ...
    iget-boolean v2, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBd:Z
    ...
    new-instance v4, Lcom/android/settings/wifi/E;

    invoke-direct {v4, p0}, Lcom/android/settings/wifi/E;-><init>(Lcom/android/settings/wifi/MiuiWifiService;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/MiuiWifiService;->tb:Landroid/widget/CheckBox;
    ...
    .line 440
    iput-boolean v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->aBd:Z
...
.method public xw()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/openwifi/l;->yX()Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/openwifi/l;->yR()Z
    ...
    .line 482
    iget-object v1, p0, Lcom/android/settings/wifi/MiuiWifiService;->aAL:Lcom/android/settings/wifi/openwifi/l;
...
.method public xy()I
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/openwifi/l;->xy()I
...
.method public xz()I
    ...
    invoke-virtual {v0}, Lcom/android/settings/wifi/openwifi/l;->xz()I
