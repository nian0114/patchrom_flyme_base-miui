...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/wifi/M;->aBy:[I
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/settings/wifi/M;->aBz:I
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/M;->aBA:Ljava/util/List;
...
.method public dD(I)Lmiui/telephony/SubscriptionInfo;
    ...
    .prologue
    .line 53
    iget-object v0, p0, Lcom/android/settings/wifi/M;->aBA:Ljava/util/List;
...
.method public dE(I)V
    ...
    .line 78
    iput p1, p0, Lcom/android/settings/wifi/M;->aBz:I
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/O;->aBB:Landroid/widget/CheckedTextView;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/O;->aBC:Landroid/widget/ImageView;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/O;->aBD:Landroid/widget/TextView;
    ...
    .line 102
    iget-object v1, v0, Lcom/android/settings/wifi/O;->aBB:Landroid/widget/CheckedTextView;
    ...
    .line 103
    iget-object v1, v0, Lcom/android/settings/wifi/O;->aBC:Landroid/widget/ImageView;

    invoke-virtual {v1, v4}, Landroid/widget/ImageView;->setVisibility(I)V

    .line 104
    iget-object v1, v0, Lcom/android/settings/wifi/O;->aBD:Landroid/widget/TextView;

    invoke-virtual {v1, v4}, Landroid/widget/TextView;->setVisibility(I)V

    .line 105
    iget-object v0, v0, Lcom/android/settings/wifi/O;->aBB:Landroid/widget/CheckedTextView;
    ...
    .line 111
    iget-object v3, v0, Lcom/android/settings/wifi/O;->aBB:Landroid/widget/CheckedTextView;

    invoke-virtual {v3, v2}, Landroid/widget/CheckedTextView;->setText(Ljava/lang/CharSequence;)V

    .line 112
    sget-object v2, Lcom/android/settings/wifi/M;->aBy:[I
    ...
    .line 114
    iget-object v3, v0, Lcom/android/settings/wifi/O;->aBC:Landroid/widget/ImageView;

    invoke-virtual {v3, v2}, Landroid/widget/ImageView;->setImageResource(I)V

    .line 118
    :goto_2
    iget-object v2, v0, Lcom/android/settings/wifi/O;->aBD:Landroid/widget/TextView;
    ...
    .line 119
    iget-object v2, v0, Lcom/android/settings/wifi/O;->aBC:Landroid/widget/ImageView;
    ...
    iget v1, p0, Lcom/android/settings/wifi/M;->aBz:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/P;->aBB:Landroid/widget/CheckedTextView;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/P;->aBC:Landroid/widget/ImageView;
    ...
    .line 150
    iget-object v1, v0, Lcom/android/settings/wifi/P;->aBB:Landroid/widget/CheckedTextView;
    ...
    .line 151
    iget-object v1, v0, Lcom/android/settings/wifi/P;->aBC:Landroid/widget/ImageView;

    invoke-virtual {v1, v5}, Landroid/widget/ImageView;->setVisibility(I)V

    .line 166
    :goto_1
    iget-object v0, v0, Lcom/android/settings/wifi/P;->aBB:Landroid/widget/CheckedTextView;
    ...
    .line 157
    iget-object v3, v0, Lcom/android/settings/wifi/P;->aBB:Landroid/widget/CheckedTextView;
    ...
    .line 160
    iget-object v2, v0, Lcom/android/settings/wifi/P;->aBC:Landroid/widget/ImageView;
