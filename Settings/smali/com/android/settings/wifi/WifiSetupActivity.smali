...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->mG:Landroid/content/IntentFilter;

    .line 77
    new-instance v0, Lcom/android/settings/wifi/ay;

    invoke-direct {v0, p0}, Lcom/android/settings/wifi/ay;-><init>(Lcom/android/settings/wifi/WifiSetupActivity;)V
...
.method static synthetic a(Lcom/android/settings/wifi/WifiSetupActivity;)V
    ...
    .prologue
    .line 40
    invoke-direct {p0}, Lcom/android/settings/wifi/WifiSetupActivity;->yA()V
...
.method private bN(Z)V
    ...
    .prologue
    .line 151
    iget-object v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->Ai:Lcom/android/setupwizardlib/view/NavigationBar;
...
.method private yA()V
    ...
    .line 125
    iget-boolean v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEf:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEi:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/WifiSetupActivity;->cf(I)V

    .line 130
    iput-boolean v2, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEi:Z

    .line 132
    :cond_0
    const v0, 0x7f0c0058

    invoke-direct {p0, v0}, Lcom/android/settings/wifi/WifiSetupActivity;->dK(I)V

    .line 133
    invoke-direct {p0, v3}, Lcom/android/settings/wifi/WifiSetupActivity;->bN(Z)V
    ...
    .line 134
    :cond_1
    iget-boolean v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEh:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEg:Z
    ...
    .line 138
    :cond_2
    invoke-direct {p0, v1}, Lcom/android/settings/wifi/WifiSetupActivity;->dK(I)V

    .line 139
    invoke-direct {p0, v2}, Lcom/android/settings/wifi/WifiSetupActivity;->bN(Z)V
...
.method public a(Lcom/android/setupwizardlib/view/NavigationBar;)V
    ...
    .prologue
    .line 206
    iput-object p1, p0, Lcom/android/settings/wifi/WifiSetupActivity;->Ai:Lcom/android/setupwizardlib/view/NavigationBar;

    .line 207
    invoke-virtual {p1, p0}, Lcom/android/setupwizardlib/view/NavigationBar;->a(Lcom/android/setupwizardlib/view/c;)V

    .line 208
    invoke-static {p0}, Lcom/android/settings/hJ;->a(Landroid/app/Activity;)V
...
.method public ia()V
    ...
    .line 225
    :goto_1
    invoke-static {v0}, Lcom/android/settings/wifi/az;->dL(I)Lcom/android/settings/wifi/az;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/settings/wifi/az;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method protected isValidFragment(Ljava/lang/String;)Z
    ...
    .prologue
    .line 188
    const-class v0, Lcom/android/settings/wifi/aw;
...
.method protected onApplyThemeResource(Landroid/content/res/Resources$Theme;IZ)V
    ...
    invoke-static {v0}, Lcom/android/settings/hJ;->n(Landroid/content/Intent;)I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 92
    iget-object v2, p0, Lcom/android/settings/wifi/WifiSetupActivity;->mG:Landroid/content/IntentFilter;
    ...
    iput-boolean v2, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEf:Z
    ...
    iput-boolean v2, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEg:Z
    ...
    iput-boolean v2, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEh:Z
    ...
    :cond_0
    iput-boolean v0, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEi:Z
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/WifiSetupActivity;->mG:Landroid/content/IntentFilter;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/wifi/WifiSetupActivity;->aEi:Z
