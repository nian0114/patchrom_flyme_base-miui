...
.field aEK:Lcom/android/settings/wifi/WpsDialog$DialogState;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEJ:Ljava/lang/String;

    .line 77
    sget-object v0, Lcom/android/settings/wifi/WpsDialog$DialogState;->aEP:Lcom/android/settings/wifi/WpsDialog$DialogState;

    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEK:Lcom/android/settings/wifi/WpsDialog$DialogState;

    .line 81
    iput-object p1, p0, Lcom/android/settings/wifi/WpsDialog;->mContext:Landroid/content/Context;

    .line 82
    iput p2, p0, Lcom/android/settings/wifi/WpsDialog;->aEI:I

    .line 124
    new-instance v0, Lcom/android/settings/wifi/aP;

    invoke-direct {v0, p0}, Lcom/android/settings/wifi/aP;-><init>(Lcom/android/settings/wifi/WpsDialog;)V

    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEH:Landroid/net/wifi/WifiManager$WpsCallback;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->mG:Landroid/content/IntentFilter;

    .line 128
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->mG:Landroid/content/IntentFilter;
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/wifi/aO;-><init>(Lcom/android/settings/wifi/WpsDialog;)V
...
.method private a(Lcom/android/settings/wifi/WpsDialog$DialogState;Ljava/lang/String;)V
    ...
    .prologue
    .line 230
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEK:Lcom/android/settings/wifi/WpsDialog$DialogState;
    ...
    .line 234
    :cond_0
    iput-object p1, p0, Lcom/android/settings/wifi/WpsDialog;->aEK:Lcom/android/settings/wifi/WpsDialog$DialogState;

    .line 235
    iput-object p2, p0, Lcom/android/settings/wifi/WpsDialog;->aEJ:Ljava/lang/String;

    .line 237
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/settings/wifi/aT;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/settings/wifi/aT;-><init>(Lcom/android/settings/wifi/WpsDialog;Lcom/android/settings/wifi/WpsDialog$DialogState;Ljava/lang/String;)V
...
.method static synthetic b(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/ProgressBar;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEF:Landroid/widget/ProgressBar;
...
.method static synthetic e(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/Button;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->gc:Landroid/widget/Button;
...
.method static synthetic g(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/TextView;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->azD:Landroid/widget/TextView;
...
.method private g(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 269
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->je:Landroid/net/wifi/WifiManager;
    ...
    .line 273
    sget-object v1, Lcom/android/settings/wifi/WpsDialog$DialogState;->aES:Lcom/android/settings/wifi/WpsDialog$DialogState;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->azD:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEF:Landroid/widget/ProgressBar;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->gc:Landroid/widget/Button;
    ...
    new-instance v1, Lcom/android/settings/wifi/aQ;

    invoke-direct {v1, p0}, Lcom/android/settings/wifi/aQ;-><init>(Lcom/android/settings/wifi/WpsDialog;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->je:Landroid/net/wifi/WifiManager;
    ...
    .line 184
    iget v1, p0, Lcom/android/settings/wifi/WpsDialog;->aEI:I

    iput v1, v0, Landroid/net/wifi/WpsInfo;->setup:I

    .line 185
    iget-object v1, p0, Lcom/android/settings/wifi/WpsDialog;->je:Landroid/net/wifi/WifiManager;

    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->aEH:Landroid/net/wifi/WifiManager$WpsCallback;
...
.method public onSaveInstanceState()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->aEK:Lcom/android/settings/wifi/WpsDialog$DialogState;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->aEJ:Ljava/lang/String;
...
.method protected onStart()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEG:Ljava/util/Timer;

    .line 196
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->aEG:Ljava/util/Timer;

    new-instance v1, Lcom/android/settings/wifi/aR;

    invoke-direct {v1, p0}, Lcom/android/settings/wifi/aR;-><init>(Lcom/android/settings/wifi/WpsDialog;)V
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->mG:Landroid/content/IntentFilter;
