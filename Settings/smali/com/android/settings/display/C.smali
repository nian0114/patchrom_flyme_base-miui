...
# instance fields
.field final synthetic Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;
...
.method constructor <init>(Lcom/android/settings/display/PaperModeSetAppsFragment;Landroid/app/FragmentManager;Ljava/util/List;)V
    ...
    .prologue
    .line 146
    iput-object p1, p0, Lcom/android/settings/display/C;->Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;
    ...
    iput-object v0, p0, Lcom/android/settings/display/C;->Zt:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/settings/display/C;->Zu:Ljava/util/List;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    .prologue
    .line 158
    iget-object v0, p0, Lcom/android/settings/display/C;->Zt:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    .line 159
    iget-object v0, p0, Lcom/android/settings/display/C;->Zu:Ljava/util/List;
    ...
    .line 161
    iget-object v1, p0, Lcom/android/settings/display/C;->Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;
    ...
    .line 163
    iget-object v1, p0, Lcom/android/settings/display/C;->Zt:Ljava/util/List;

    new-instance v3, Lcom/android/settings/display/E;

    iget-object v4, p0, Lcom/android/settings/display/C;->Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;

    iget-object v5, p0, Lcom/android/settings/display/C;->Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;
    ...
    .line 166
    :cond_2
    iget-object v1, p0, Lcom/android/settings/display/C;->Zu:Ljava/util/List;
...
.method protected onPostExecute(Ljava/lang/Void;)V
    ...
    .line 153
    iget-object v0, p0, Lcom/android/settings/display/C;->Zs:Lcom/android/settings/display/PaperModeSetAppsFragment;

    iget-object v1, p0, Lcom/android/settings/display/C;->Zt:Ljava/util/List;

    iget-object v2, p0, Lcom/android/settings/display/C;->Zu:Ljava/util/List;
