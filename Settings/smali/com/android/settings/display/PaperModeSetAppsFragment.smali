...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/display/B;-><init>(Lcom/android/settings/display/PaperModeSetAppsFragment;)V

    iput-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->bD:Landroid/content/BroadcastReceiver;
...
.method private P()V
    ...
    iput-object v1, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zp:Ljava/util/HashMap;
    ...
    invoke-direct {v1, p0, v2, v0}, Lcom/android/settings/display/C;-><init>(Lcom/android/settings/display/PaperModeSetAppsFragment;Landroid/app/FragmentManager;Ljava/util/List;)V

    const v0, 0x7f0c0f0d

    invoke-virtual {v1, v0}, Lcom/android/settings/display/C;->setMessage(I)Lmiui/os/AsyncTaskWithProgress;
...
.method static synthetic a(Lcom/android/settings/display/PaperModeSetAppsFragment;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0}, Lcom/android/settings/display/PaperModeSetAppsFragment;->P()V
...
.method private a(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 110
    iget-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zq:Landroid/preference/PreferenceCategory;

    invoke-virtual {v0}, Landroid/preference/PreferenceCategory;->removeAll()V

    .line 111
    iget-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zr:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zq:Landroid/preference/PreferenceCategory;
    ...
    .line 116
    iget-object v3, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zq:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zr:Landroid/preference/PreferenceCategory;
...
.method static synthetic c(Lcom/android/settings/display/PaperModeSetAppsFragment;)Ljava/util/HashMap;
    ...
    .prologue
    .line 37
    iget-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zp:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zq:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zr:Landroid/preference/PreferenceCategory;
    ...
    iget-object v2, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->bD:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->bD:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 99
    instance-of v1, p1, Lcom/android/settings/display/E;

    if-eqz v1, :cond_0

    .line 100
    iget-object v1, p0, Lcom/android/settings/display/PaperModeSetAppsFragment;->Zp:Ljava/util/HashMap;
