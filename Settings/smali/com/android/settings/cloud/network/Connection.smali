...
.field protected TR:Lcom/android/settings/cloud/network/b;
...
.method private a(Ljava/lang/String;Ljava/lang/String;ZZLjava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 304
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->TX:Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_7
    ...
    .line 250
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->TW:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method private a(Ljava/net/URL;)V
    ...
    .line 90
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->TT:Z

    .line 91
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->TU:Z
    ...
    .line 93
    iput-object p1, p0, Lcom/android/settings/cloud/network/Connection;->TQ:Ljava/net/URL;
...
.method private bn(I)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 364
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->Ub:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method protected a(Ljava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .prologue
    .line 187
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->TQ:Ljava/net/URL;
    ...
    .line 192
    :cond_0
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->TR:Lcom/android/settings/cloud/network/b;
    ...
    iput-object v0, p0, Lcom/android/settings/cloud/network/Connection;->TR:Lcom/android/settings/cloud/network/b;

    .line 196
    :cond_1
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->TT:Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/cloud/network/b;->oH()V
    ...
    .line 210
    iget-boolean v1, p0, Lcom/android/settings/cloud/network/Connection;->TS:Z
    ...
    .line 214
    iget-object v1, p0, Lcom/android/settings/cloud/network/Connection;->TQ:Ljava/net/URL;
    ...
    .line 233
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->TS:Z
    ...
    .line 237
    :cond_4
    iget-boolean v3, p0, Lcom/android/settings/cloud/network/Connection;->TS:Z

    iget-boolean v4, p0, Lcom/android/settings/cloud/network/Connection;->TU:Z
...
.method public aE(Z)V
    ...
    .prologue
    .line 110
    iput-boolean p1, p0, Lcom/android/settings/cloud/network/Connection;->TS:Z
...
.method public oE()Lorg/json/JSONObject;
    ...
    .prologue
    .line 98
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->TP:Lorg/json/JSONObject;

    return-object v0
.end method

.method public oF()Lcom/android/settings/cloud/network/b;
    .locals 1
...
.method public oG()Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 5
    ...
    iput-object v2, p0, Lcom/android/settings/cloud/network/Connection;->TP:Lorg/json/JSONObject;
    :try_end_0
