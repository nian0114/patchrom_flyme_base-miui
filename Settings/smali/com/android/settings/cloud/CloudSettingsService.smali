...
.method private c(Lorg/json/JSONObject;)Lcom/android/settings/cloud/network/a;
    ...
    iput-object v2, v1, Lcom/android/settings/cloud/network/a;->TM:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/android/settings/cloud/network/a;->TN:Ljava/lang/String;
    ...
    iput-wide v2, v1, Lcom/android/settings/cloud/network/a;->TO:J
    :try_end_0
    ...
    iget-object v2, v1, Lcom/android/settings/cloud/network/a;->TM:Ljava/lang/String;
    ...
    iget-object v2, v1, Lcom/android/settings/cloud/network/a;->TN:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/settings/cloud/network/a;->TO:J
...
.method private e(Ljava/io/File;)I
    ...
    sget-object v2, Lcom/android/settings/cloud/i;->TJ:Landroid/net/Uri;
...
.method private oj()V
    ...
    .line 68
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->ol()Z
    ...
    sget-object v6, Lcom/android/settings/cloud/h;->SX:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->om()Ljava/lang/String;
    ...
    .line 99
    invoke-virtual {v5}, Lcom/android/settings/cloud/network/Connection;->oG()Lcom/android/settings/cloud/network/Connection$NetworkError;

    move-result-object v6

    sget-object v7, Lcom/android/settings/cloud/network/Connection$NetworkError;->TV:Lcom/android/settings/cloud/network/Connection$NetworkError;

    if-ne v6, v7, :cond_0

    .line 102
    invoke-virtual {v5}, Lcom/android/settings/cloud/network/Connection;->oE()Lorg/json/JSONObject;
    ...
    .line 128
    :cond_4
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->ok()Lcom/android/settings/cloud/network/a;
    ...
    .line 143
    iget-object v3, v0, Lcom/android/settings/cloud/network/a;->TN:Ljava/lang/String;
    ...
    iget-wide v2, v0, Lcom/android/settings/cloud/network/a;->TO:J
...
.method private ok()Lcom/android/settings/cloud/network/a;
    .locals 7
    ...
    sget-object v2, Lcom/android/settings/cloud/h;->SW:Ljava/lang/String;
    ...
    .line 219
    invoke-virtual {v1}, Lcom/android/settings/cloud/network/Connection;->oG()Lcom/android/settings/cloud/network/Connection$NetworkError;

    move-result-object v2

    sget-object v3, Lcom/android/settings/cloud/network/Connection$NetworkError;->TV:Lcom/android/settings/cloud/network/Connection$NetworkError;

    if-ne v2, v3, :cond_0

    .line 220
    invoke-virtual {v1}, Lcom/android/settings/cloud/network/Connection;->oE()Lorg/json/JSONObject;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    .line 59
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/cloud/CloudSettingsService;->oj()V
