...
.field private gV:Lcom/android/settings/widget/ChartNetworkSeriesView;

.field private gW:Lcom/android/settings/bO;
...
.field private hD:Lcom/android/settings/DataUsageSummary$AppItem;

.field private hE:Landroid/content/Intent;

.field private hF:Lcom/android/settings/d/f;
...
.field private hQ:Lcom/android/settings/d/j;
...
.field private hj:Lcom/android/settings/bK;

.field private hk:Landroid/widget/TextView;

.field private hl:Lcom/android/settings/widget/ChartDataUsageView;
...
.field private ic:Lcom/android/settings/widget/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/DataUsageSummary;->ie:Ljava/lang/StringBuilder;

    .line 1599
    new-instance v0, Ljava/util/Formatter;

    sget-object v1, Lcom/android/settings/DataUsageSummary;->ie:Ljava/lang/StringBuilder;
    ...
    sput-object v0, Lcom/android/settings/DataUsageSummary;->if:Ljava/util/Formatter;

    .line 2724
    new-instance v0, Lcom/android/settings/bw;

    invoke-direct {v0}, Lcom/android/settings/bw;-><init>()V

    sput-object v0, Lcom/android/settings/DataUsageSummary;->ig:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    .line 223
    iput v0, p0, Lcom/android/settings/DataUsageSummary;->gX:I

    .line 258
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->hz:Z

    .line 259
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->hA:Z

    .line 264
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hD:Lcom/android/settings/DataUsageSummary$AppItem;

    .line 270
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;

    .line 271
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hH:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hS:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hT:Landroid/widget/TabHost$TabContentFactory;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hU:Landroid/widget/TabHost$OnTabChangeListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hV:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hW:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hX:Landroid/view/View$OnClickListener;

    .line 1349
    new-instance v0, Lcom/android/settings/br;

    invoke-direct {v0, p0}, Lcom/android/settings/br;-><init>(Lcom/android/settings/DataUsageSummary;)V

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hY:Landroid/widget/AdapterView$OnItemClickListener;

    .line 1363
    new-instance v0, Lcom/android/settings/bs;

    invoke-direct {v0, p0}, Lcom/android/settings/bs;-><init>(Lcom/android/settings/DataUsageSummary;)V

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hZ:Landroid/widget/AdapterView$OnItemSelectedListener;

    .line 1463
    new-instance v0, Lcom/android/settings/bt;

    invoke-direct {v0, p0}, Lcom/android/settings/bt;-><init>(Lcom/android/settings/DataUsageSummary;)V

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ia:Landroid/app/LoaderManager$LoaderCallbacks;

    .line 1494
    new-instance v0, Lcom/android/settings/bu;

    invoke-direct {v0, p0}, Lcom/android/settings/bu;-><init>(Lcom/android/settings/DataUsageSummary;)V

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ib:Landroid/app/LoaderManager$LoaderCallbacks;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ic:Lcom/android/settings/widget/e;
...
.method static synthetic a(Lcom/android/settings/DataUsageSummary;Ljava/lang/String;)I
    ...
    .prologue
    .line 163
    invoke-direct {p0, p1}, Lcom/android/settings/DataUsageSummary;->x(Ljava/lang/String;)I
...
.method static synthetic a(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsService;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gN:Landroid/net/INetworkStatsService;
...
.method private a(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/widget/TabHost$TabSpec;
    ...
    .prologue
    .line 780
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gR:Landroid/widget/TabHost;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hT:Landroid/widget/TabHost$TabContentFactory;
...
.method static synthetic a(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/DataUsageSummary$AppItem;)Lcom/android/settings/DataUsageSummary$AppItem;
    ...
    .prologue
    .line 163
    iput-object p1, p0, Lcom/android/settings/DataUsageSummary;->hD:Lcom/android/settings/DataUsageSummary$AppItem;
...
.method static synthetic a(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/d/a;)Lcom/android/settings/d/a;
    ...
    .prologue
    .line 163
    iput-object p1, p0, Lcom/android/settings/DataUsageSummary;->hC:Lcom/android/settings/d/a;
...
.method public static a(Landroid/content/Context;JJ)Ljava/lang/String;
    ...
    .line 1603
    .line 1605
    sget-object v8, Lcom/android/settings/DataUsageSummary;->ie:Ljava/lang/StringBuilder;

    monitor-enter v8

    .line 1606
    :try_start_0
    sget-object v0, Lcom/android/settings/DataUsageSummary;->ie:Ljava/lang/StringBuilder;
    ...
    .line 1607
    sget-object v1, Lcom/android/settings/DataUsageSummary;->if:Ljava/util/Formatter;
...
.method private a(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;Z)V
    ...
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hO:Ljava/util/Map;
    ...
    .line 2767
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gR:Landroid/widget/TabHost;
...
.method private a(Landroid/telephony/SubscriptionInfo;)V
    ...
    .prologue
    .line 1234
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hN:Ljava/util/List;
...
.method private a(Landroid/net/NetworkPolicy;)Z
    ...
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hc:Landroid/widget/Switch;
...
.method private b(Landroid/net/NetworkPolicy;)V
    ...
    .line 1167
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hi:Landroid/widget/Spinner;
    ...
    check-cast v6, Lcom/android/settings/bN;

    .line 1168
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    invoke-virtual {v0}, Lcom/android/settings/bK;->clear()V
    ...
    .line 1174
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hC:Lcom/android/settings/d/a;
    ...
    iget-object v0, v0, Lcom/android/settings/d/a;->ahP:Landroid/net/NetworkStatsHistory;
    ...
    .line 1193
    iget-object v12, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    new-instance v0, Lcom/android/settings/bN;

    invoke-direct/range {v0 .. v5}, Lcom/android/settings/bN;-><init>(Landroid/content/Context;JJ)V

    invoke-virtual {v12, v0}, Lcom/android/settings/bK;->add(Ljava/lang/Object;)V
    ...
    .line 1199
    :cond_0
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    invoke-direct {p0, p1}, Lcom/android/settings/DataUsageSummary;->a(Landroid/net/NetworkPolicy;)Z

    move-result v3

    invoke-virtual {v2, v3}, Lcom/android/settings/bK;->m(Z)V
    ...
    .line 1207
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    new-instance v0, Lcom/android/settings/bN;

    invoke-direct/range {v0 .. v5}, Lcom/android/settings/bN;-><init>(Landroid/content/Context;JJ)V

    invoke-virtual {v8, v0}, Lcom/android/settings/bK;->add(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v7}, Lcom/android/settings/bK;->m(Z)V

    .line 1215
    :cond_2
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    invoke-virtual {v0}, Lcom/android/settings/bK;->getCount()I
    ...
    invoke-virtual {v0, v6}, Lcom/android/settings/bK;->a(Lcom/android/settings/bN;)I
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/bK;->getItem(I)Ljava/lang/Object;
    ...
    .line 1223
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hZ:Landroid/widget/AdapterView$OnItemSelectedListener;

    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hi:Landroid/widget/Spinner;
    ...
    .line 1226
    :cond_3
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bw()V
...
.method private b(Landroid/view/View;)V
    ...
    .line 481
    invoke-virtual {v1, v0}, Lcom/android/settings/DataUsageSummary$AppItem;->v(I)V

    .line 483
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hQ:Lcom/android/settings/d/j;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hR:Ljava/lang/String;
...
.method static synthetic b(Lcom/android/settings/DataUsageSummary;)V
    ...
    .prologue
    .line 163
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->br()V
...
.method static synthetic b(Lcom/android/settings/DataUsageSummary;Z)V
    ...
    .prologue
    .line 163
    invoke-direct {p0, p1}, Lcom/android/settings/DataUsageSummary;->k(Z)V
...
.method private bn()V
    ...
    .prologue
    .line 600
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gO:Landroid/net/NetworkPolicyManager;
    ...
    .line 601
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hI:Landroid/view/MenuItem;
    ...
    .line 606
    :goto_0
    iget-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->hz:Z

    if-eqz v0, :cond_1

    .line 607
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hJ:Landroid/view/MenuItem;
    ...
    .line 612
    :goto_1
    iget-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->hA:Z

    if-eqz v0, :cond_2

    .line 613
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hK:Landroid/view/MenuItem;
...
.method private bo()V
    ...
    .line 692
    :cond_1
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hl:Lcom/android/settings/widget/ChartDataUsageView;
    ...
    .line 694
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gS:Landroid/view/ViewGroup;

    invoke-static {}, Lcom/android/settings/DataUsageSummary;->bp()Landroid/animation/LayoutTransition;
    ...
    .line 695
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gY:Landroid/view/ViewGroup;
    ...
    .line 696
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gZ:Landroid/view/ViewGroup;
    ...
    .line 701
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hl:Lcom/android/settings/widget/ChartDataUsageView;
...
.method private bq()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/DataUsageSummary;->i(Landroid/content/Context;)Z
    ...
    .line 739
    :cond_3
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gT:Landroid/widget/TabWidget;
    ...
    .line 740
    :goto_2
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gT:Landroid/widget/TabWidget;
    ...
    .line 742
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hH:Ljava/lang/String;

    if-eqz v1, :cond_9

    .line 743
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hH:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hH:Ljava/lang/String;
...
.method private br()V
    ...
    .line 809
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->bz:Landroid/widget/ListView;
    ...
    .line 812
    :cond_2
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->bz:Landroid/widget/ListView;

    invoke-virtual {v3, v8}, Landroid/widget/ListView;->setVisibility(I)V

    .line 815
    iput-object v2, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;

    .line 819
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->hb:Z

    .line 820
    iput-boolean v1, p0, Lcom/android/settings/DataUsageSummary;->he:Z

    .line 826
    invoke-static {v2}, Lcom/android/settings/DataUsageSummary;->u(Ljava/lang/String;)Z
    ...
    .line 829
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hg:Landroid/view/View;
    ...
    .line 830
    invoke-direct {p0, v2}, Lcom/android/settings/DataUsageSummary;->x(Ljava/lang/String;)I

    move-result v0

    invoke-direct {p0, v0}, Lcom/android/settings/DataUsageSummary;->u(I)Z
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hB:Landroid/net/NetworkTemplate;

    .line 836
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hB:Landroid/net/NetworkTemplate;
    ...
    .line 872
    :goto_2
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hF:Lcom/android/settings/d/f;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hB:Landroid/net/NetworkTemplate;
    ...
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->hB:Landroid/net/NetworkTemplate;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hD:Lcom/android/settings/DataUsageSummary$AppItem;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->ia:Landroid/app/LoaderManager$LoaderCallbacks;
    ...
    .line 905
    iput-boolean v8, p0, Lcom/android/settings/DataUsageSummary;->hP:Z
    ...
    .line 908
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;
    ...
    .line 921
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->gU:Lcom/android/settings/widget/ChartNetworkSeriesView;

    invoke-virtual {v2, v11, v0, v1}, Lcom/android/settings/widget/ChartNetworkSeriesView;->c(III)V

    .line 922
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->gV:Lcom/android/settings/widget/ChartNetworkSeriesView;
    ...
    .line 844
    invoke-static {v9}, Lcom/android/settings/DataUsageSummary;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 856
    iput-boolean v8, p0, Lcom/android/settings/DataUsageSummary;->hb:Z

    .line 857
    iput-boolean v8, p0, Lcom/android/settings/DataUsageSummary;->he:Z
...
.method private bs()Z
    ...
    .prologue
    .line 926
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hD:Lcom/android/settings/DataUsageSummary$AppItem;
...
.method private bt()V
    ...
    .line 938
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bs()Z
    ...
    .line 939
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hp:Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/bK;->n(Z)V
    ...
    .line 958
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hq:Landroid/widget/ImageView;
    ...
    .line 960
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hr:Landroid/view/ViewGroup;
    ...
    .line 963
    iget-object v0, v7, Lcom/android/settings/d/i;->aib:[Ljava/lang/CharSequence;
    ...
    .line 967
    iget-object v0, v7, Lcom/android/settings/d/i;->aic:[Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->hr:Landroid/view/ViewGroup;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hr:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hs:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hE:Landroid/content/Intent;

    .line 993
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hE:Landroid/content/Intent;
    ...
    .line 998
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->hE:Landroid/content/Intent;

    invoke-virtual {v8, v7}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    .line 999
    iget-object v7, p0, Lcom/android/settings/DataUsageSummary;->hE:Landroid/content/Intent;
    ...
    .line 1005
    :cond_3
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hv:Landroid/widget/Button;

    new-instance v2, Lcom/android/settings/bA;

    invoke-direct {v2, p0, v6}, Lcom/android/settings/bA;-><init>(Lcom/android/settings/DataUsageSummary;I)V
    ...
    .line 1018
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hv:Landroid/widget/Button;
    ...
    .line 1030
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hy:Landroid/view/View;
    ...
    .line 1035
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hx:Landroid/widget/Switch;

    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bu()Z
...
.method private bu()Z
    ...
    .line 1105
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gO:Landroid/net/NetworkPolicyManager;
...
.method private bv()V
    ...
    .line 1272
    invoke-direct {p0, v0}, Lcom/android/settings/DataUsageSummary;->j(Landroid/content/Context;)Landroid/telephony/SubscriptionInfo;
    ...
    .line 1283
    invoke-static {v0}, Lcom/android/settings/iE;->ag(Landroid/content/Context;)Z
    ...
    new-instance v3, Lcom/android/settings/bC;

    invoke-direct {v3, p0, v1}, Lcom/android/settings/bC;-><init>(Lcom/android/settings/DataUsageSummary;Landroid/telephony/SubscriptionInfo;)V
...
.method private bw()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/widget/ChartDataUsageView;->we()J
    ...
    invoke-virtual {v0}, Lcom/android/settings/widget/ChartDataUsageView;->wf()J
    ...
    iget-object v1, v0, Lcom/android/settings/d/a;->ahR:Landroid/net/NetworkStatsHistory;
    ...
    iget-object v1, v0, Lcom/android/settings/d/a;->ahS:Landroid/net/NetworkStatsHistory;
    ...
    .line 1419
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->hs:Landroid/widget/TextView;
    ...
    .line 1422
    :cond_0
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->hu:Landroid/widget/TextView;
    ...
    .line 1423
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->ht:Landroid/widget/TextView;
    ...
    iget-object v1, v0, Lcom/android/settings/d/a;->ahQ:Landroid/net/NetworkStatsHistory;
    ...
    .line 1430
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hk:Landroid/widget/TextView;
    ...
    .line 1446
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hk:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 1448
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;

    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->u(Ljava/lang/String;)Z
    ...
    .line 1451
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hm:Landroid/view/View;
    ...
    .line 1460
    :goto_2
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bo()V
    ...
    iget-object v1, v0, Lcom/android/settings/d/a;->ahP:Landroid/net/NetworkStatsHistory;
    ...
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hB:Landroid/net/NetworkTemplate;

    invoke-static {v6, v2, v3, v4, v5}, Lcom/android/settings/d/h;->a(Landroid/net/NetworkTemplate;JJ)Landroid/os/Bundle;

    move-result-object v2

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->ib:Landroid/app/LoaderManager$LoaderCallbacks;
...
.method private d(J)V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/DataUsageSummary;->l(Z)V
...
.method private f(IZ)V
    ...
    .line 1080
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hS:Ljava/util/Map;
...
.method static synthetic h(Lcom/android/settings/DataUsageSummary;)V
    ...
    .prologue
    .line 163
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bv()V
...
.method private isBandwidthControlEnabled()Z
    ...
    .line 1091
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gM:Landroid/os/INetworkManagementService;
...
.method private j(Landroid/content/Context;)Landroid/telephony/SubscriptionInfo;
    ...
    .line 2783
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hN:Ljava/util/List;
...
.method static synthetic j(Lcom/android/settings/DataUsageSummary;)Landroid/widget/Switch;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hf:Landroid/widget/Switch;
...
.method private k(Z)V
    ...
    .line 1112
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->gO:Landroid/net/NetworkPolicyManager;
...
.method private l(Z)V
    ...
    .line 1122
    iget-boolean v2, p0, Lcom/android/settings/DataUsageSummary;->hb:Z

    .line 1123
    iget-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->he:Z
    ...
    .line 1131
    :cond_0
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;

    invoke-static {v5}, Lcom/android/settings/DataUsageSummary;->u(Ljava/lang/String;)Z
    ...
    .line 1132
    iput-boolean v3, p0, Lcom/android/settings/DataUsageSummary;->hP:Z

    .line 1133
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->hc:Landroid/widget/Switch;

    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hG:Ljava/lang/String;

    invoke-direct {p0, v6}, Lcom/android/settings/DataUsageSummary;->x(Ljava/lang/String;)I
    ...
    .line 1137
    :cond_1
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->hF:Lcom/android/settings/d/f;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/DataUsageSummary;->u(I)Z
    ...
    .line 1140
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hf:Landroid/widget/Switch;
    ...
    .line 1142
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hl:Lcom/android/settings/widget/ChartDataUsageView;
    ...
    :cond_2
    :goto_1
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hd:Landroid/view/View;
    ...
    .line 1152
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->hg:Landroid/view/View;
...
.method static synthetic p(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsSession;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gP:Landroid/net/INetworkStatsSession;
...
.method static synthetic r(Lcom/android/settings/DataUsageSummary;)V
    ...
    .prologue
    .line 163
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bt()V
...
.method private t(I)Z
    ...
    .line 1065
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hS:Ljava/util/Map;
...
.method static synthetic u(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/bO;
    .locals 1

    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gW:Lcom/android/settings/bO;
...
.method static synthetic w(Lcom/android/settings/DataUsageSummary;)Landroid/widget/TextView;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hn:Landroid/widget/TextView;
...
.method private x(Ljava/lang/String;)I
    ...
    .line 2820
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hO:Ljava/util/Map;
...
.method static synthetic x(Lcom/android/settings/DataUsageSummary;)Landroid/view/View;
    ...
    .prologue
    .line 163
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->ho:Landroid/view/View;
...
.method static synthetic y(Ljava/lang/String;)Z
    ...
    .prologue
    .line 163
    invoke-static {p0}, Lcom/android/settings/DataUsageSummary;->u(Ljava/lang/String;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gM:Landroid/os/INetworkManagementService;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gN:Landroid/net/INetworkStatsService;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gO:Landroid/net/NetworkPolicyManager;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gQ:Landroid/content/SharedPreferences;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hF:Lcom/android/settings/d/f;

    .line 316
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hF:Lcom/android/settings/d/f;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hN:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hO:Ljava/util/Map;

    .line 322
    :try_start_0
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gM:Landroid/os/INetworkManagementService;
    ...
    :goto_0
    :try_start_1
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gN:Landroid/net/INetworkStatsService;

    invoke-interface {v1}, Landroid/net/INetworkStatsService;->openSession()Landroid/net/INetworkStatsSession;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gP:Landroid/net/INetworkStatsSession;
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1

    .line 337
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gQ:Landroid/content/SharedPreferences;
    ...
    iput-boolean v1, p0, Lcom/android/settings/DataUsageSummary;->hz:Z
    ...
    iput-boolean v1, p0, Lcom/android/settings/DataUsageSummary;->hA:Z
    ...
    .line 342
    iput-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->hz:Z

    .line 343
    iput-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->hA:Z
    ...
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hQ:Lcom/android/settings/d/j;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gR:Landroid/widget/TabHost;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gS:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gT:Landroid/widget/TabWidget;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->bz:Landroid/widget/ListView;
    ...
    .line 373
    :cond_0
    iput v5, p0, Lcom/android/settings/DataUsageSummary;->gX:I

    .line 376
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->bz:Landroid/widget/ListView;

    invoke-static {p2, v2, v0, v5}, Lcom/android/settings/iE;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hU:Landroid/widget/TabHost$OnTabChangeListener;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->gY:Landroid/view/ViewGroup;
    ...
    .line 388
    iget v0, p0, Lcom/android/settings/DataUsageSummary;->gX:I
    ...
    iget v3, p0, Lcom/android/settings/DataUsageSummary;->gX:I
    ...
    iget v4, p0, Lcom/android/settings/DataUsageSummary;->gX:I
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gZ:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ha:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hc:Landroid/widget/Switch;
    ...
    .line 403
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->ha:Landroid/widget/LinearLayout;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hc:Landroid/widget/Switch;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hV:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hf:Landroid/widget/Switch;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hf:Landroid/widget/Switch;

    invoke-static {p1, v0, v3}, Lcom/android/settings/DataUsageSummary;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hg:Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hW:Landroid/view/View$OnClickListener;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hg:Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->ha:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0, v3, v5}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hh:Landroid/view/View;

    .line 423
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hh:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hi:Landroid/widget/Spinner;

    .line 425
    new-instance v0, Lcom/android/settings/bK;

    invoke-direct {v0, v1}, Lcom/android/settings/bK;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;

    .line 426
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hi:Landroid/widget/Spinner;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hj:Lcom/android/settings/bK;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hZ:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hk:Landroid/widget/TextView;

    .line 429
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->ha:Landroid/widget/LinearLayout;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hh:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gU:Lcom/android/settings/widget/ChartNetworkSeriesView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->gV:Lcom/android/settings/widget/ChartNetworkSeriesView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hl:Lcom/android/settings/widget/ChartDataUsageView;

    .line 435
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hl:Lcom/android/settings/widget/ChartDataUsageView;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->ic:Lcom/android/settings/widget/e;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hp:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hq:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hr:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ht:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hu:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hw:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hv:Landroid/widget/Button;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hx:Landroid/widget/Switch;
    ...
    .line 452
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->hw:Landroid/widget/LinearLayout;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hx:Landroid/widget/Switch;

    invoke-static {p1, v0, v3}, Lcom/android/settings/DataUsageSummary;->a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hy:Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hX:Landroid/view/View$OnClickListener;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hy:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hm:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->hn:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->ho:Landroid/view/View;
    ...
    .line 464
    new-instance v1, Lcom/android/settings/bO;

    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hQ:Lcom/android/settings/d/j;

    iget v4, p0, Lcom/android/settings/DataUsageSummary;->gX:I

    invoke-direct {v1, v0, v3, v4}, Lcom/android/settings/bO;-><init>(Landroid/os/UserManager;Lcom/android/settings/d/j;I)V

    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->gW:Lcom/android/settings/bO;

    .line 465
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->bz:Landroid/widget/ListView;

    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->hY:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->gW:Lcom/android/settings/bO;
...
.method public onDestroy()V
    ...
    .line 671
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hd:Landroid/view/View;

    .line 672
    iput-object v1, p0, Lcom/android/settings/DataUsageSummary;->hg:Landroid/view/View;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :cond_2
    iput-boolean v6, p0, Lcom/android/settings/DataUsageSummary;->hz:Z

    .line 634
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->gQ:Landroid/content/SharedPreferences;
    ...
    iget-boolean v2, p0, Lcom/android/settings/DataUsageSummary;->hz:Z
    ...
    .line 635
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bn()V

    .line 636
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->bq()V
    ...
    :cond_3
    iput-boolean v6, p0, Lcom/android/settings/DataUsageSummary;->hA:Z
    ...
    iget-boolean v2, p0, Lcom/android/settings/DataUsageSummary;->hA:Z
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    iput-object v3, p0, Lcom/android/settings/DataUsageSummary;->hJ:Landroid/view/MenuItem;
    ...
    invoke-static {v4}, Lcom/android/settings/DataUsageSummary;->g(Landroid/content/Context;)Z
    ...
    .line 557
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hJ:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings/DataUsageSummary;->hK:Landroid/view/MenuItem;
    ...
    .line 564
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hK:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings/DataUsageSummary;->hI:Landroid/view/MenuItem;

    .line 570
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->hI:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings/DataUsageSummary;->hL:Landroid/view/MenuItem;

    .line 582
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hL:Landroid/view/MenuItem;
    ...
    iput-object v3, p0, Lcom/android/settings/DataUsageSummary;->hM:Landroid/view/MenuItem;

    .line 585
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hM:Landroid/view/MenuItem;
    ...
    invoke-static {v2, v0, v1, v3}, Lcom/android/settings/dn;->a(Landroid/app/Activity;Landroid/view/MenuItem;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 559
    :cond_3
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hJ:Landroid/view/MenuItem;
    ...
    .line 566
    :cond_5
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->hK:Landroid/view/MenuItem;
...
.method public onResume()V
    ...
    new-instance v1, Lcom/android/settings/bq;

    invoke-direct {v1, p0}, Lcom/android/settings/bq;-><init>(Lcom/android/settings/DataUsageSummary;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/settings/bx;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
