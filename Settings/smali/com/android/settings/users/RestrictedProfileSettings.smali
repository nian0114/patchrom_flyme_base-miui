...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->auc:Lcom/android/settings/users/EditUserInfoController;
...
.method public f(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 154
    iget-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->aua:Landroid/widget/TextView;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->aua:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->aub:Landroid/widget/ImageView;

    .line 66
    iget-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->aub:Landroid/widget/ImageView;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 103
    iget-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->auc:Lcom/android/settings/users/EditUserInfoController;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v1, p0, Lcom/android/settings/users/RestrictedProfileSettings;->atZ:Landroid/widget/ImageView;

    invoke-virtual {v1}, Landroid/widget/ImageView;->getDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iget-object v1, p0, Lcom/android/settings/users/RestrictedProfileSettings;->aua:Landroid/widget/TextView;
    ...
    iget-object v6, p0, Lcom/android/settings/users/RestrictedProfileSettings;->atd:Landroid/os/UserHandle;
    ...
    iget-object v1, p0, Lcom/android/settings/users/RestrictedProfileSettings;->atd:Landroid/os/UserHandle;
...
.method public onResume()V
    ...
    .line 83
    iget-object v0, p0, Lcom/android/settings/users/RestrictedProfileSettings;->sS:Landroid/os/UserManager;

    iget-object v1, p0, Lcom/android/settings/users/RestrictedProfileSettings;->atd:Landroid/os/UserHandle;

    invoke-static {v0, v1}, Lcom/android/settings/iE;->b(Landroid/os/UserManager;Landroid/os/UserHandle;)Landroid/content/pm/UserInfo;
    ...
    .line 85
    invoke-virtual {p0}, Lcom/android/settings/users/RestrictedProfileSettings;->hW()V
    ...
    iget-object v3, p0, Lcom/android/settings/users/RestrictedProfileSettings;->sS:Landroid/os/UserManager;

    invoke-static {v2, v3, v1}, Lcom/android/settings/iE;->a(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
