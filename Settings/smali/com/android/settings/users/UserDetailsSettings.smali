...
.method bj(Z)V
    ...
    .line 139
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->auh:Landroid/preference/SwitchPreference;

    invoke-virtual {v2, p1}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 140
    iget-boolean v2, p0, Lcom/android/settings/users/UserDetailsSettings;->auk:Z

    if-eqz v2, :cond_2

    .line 141
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->aul:Landroid/os/Bundle;
    ...
    .line 143
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->aul:Landroid/os/Bundle;
    ...
    .line 144
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->sS:Landroid/os/UserManager;
    ...
    .line 151
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->aul:Landroid/os/Bundle;

    invoke-virtual {v0, v3}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    .line 152
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->sS:Landroid/os/UserManager;
    ...
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->auj:Landroid/content/pm/UserInfo;
    ...
    .line 157
    iget-object v4, p0, Lcom/android/settings/users/UserDetailsSettings;->sS:Landroid/os/UserManager;
    ...
    .line 159
    iget-object v2, p0, Lcom/android/settings/users/UserDetailsSettings;->sS:Landroid/os/UserManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->sS:Landroid/os/UserManager;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->auh:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->aui:Landroid/preference/Preference;
    ...
    iput-boolean v0, p0, Lcom/android/settings/users/UserDetailsSettings;->auk:Z

    .line 91
    iget-boolean v0, p0, Lcom/android/settings/users/UserDetailsSettings;->auk:Z
    ...
    iput-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->auj:Landroid/content/pm/UserInfo;

    .line 98
    iget-object v3, p0, Lcom/android/settings/users/UserDetailsSettings;->auh:Landroid/preference/SwitchPreference;
    ...
    .line 100
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->aui:Landroid/preference/Preference;
    ...
    .line 113
    :cond_1
    iget-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->auh:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/users/UserDetailsSettings;->aul:Landroid/os/Bundle;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v1, p0, Lcom/android/settings/users/UserDetailsSettings;->auj:Landroid/content/pm/UserInfo;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 118
    iget-object v1, p0, Lcom/android/settings/users/UserDetailsSettings;->aui:Landroid/preference/Preference;
...
.method removeUser()V
    ...
    .line 195
    invoke-virtual {p0}, Lcom/android/settings/users/UserDetailsSettings;->hW()V
