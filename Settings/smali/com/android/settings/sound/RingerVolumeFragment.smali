...
# instance fields
.field private aqN:[Lcom/android/settings/sound/E;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->aqR:[I
    ...
    sput-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->aqS:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqP:[I

    .line 106
    sget-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->aqR:[I

    array-length v0, v0

    new-array v0, v0, [Landroid/widget/ImageView;

    iput-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqT:[Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqU:[Lmiui/widget/SeekBar;
...
.method static synthetic a(Lcom/android/settings/sound/RingerVolumeFragment;)V
    ...
    .prologue
    .line 47
    invoke-direct {p0}, Lcom/android/settings/sound/RingerVolumeFragment;->uw()V
...
.method static synthetic c(Lcom/android/settings/sound/RingerVolumeFragment;)Landroid/net/Uri;
    ...
    .prologue
    .line 47
    invoke-direct {p0}, Lcom/android/settings/sound/RingerVolumeFragment;->sB()Landroid/net/Uri;
...
.method private cM(I)V
    ...
    .line 255
    iget-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqT:[Landroid/widget/ImageView;
    ...
    .line 258
    iget-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqT:[Landroid/widget/ImageView;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqU:[Lmiui/widget/SeekBar;
    ...
    .line 267
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqN:[Lcom/android/settings/sound/E;

    aget-object v1, v1, p1

    iget-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqU:[Lmiui/widget/SeekBar;
    ...
    .line 268
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqU:[Lmiui/widget/SeekBar;

    aget-object v1, v1, p1

    iget-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqN:[Lcom/android/settings/sound/E;
    ...
    :cond_3
    sget-object v0, Lcom/android/settings/sound/RingerVolumeFragment;->aqS:[I
...
.method private cleanup()V
    ...
    .line 318
    :cond_1
    iget-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqV:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqV:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1}, Landroid/app/Activity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    .line 320
    iput-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqV:Landroid/content/BroadcastReceiver;

    .line 322
    :cond_2
    iget-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqW:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqW:Landroid/content/BroadcastReceiver;

    invoke-virtual {v0, v1}, Landroid/app/Activity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    .line 324
    iput-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqW:Landroid/content/BroadcastReceiver;
...
.method private uw()V
    ...
    :goto_0
    sget-object v1, Lcom/android/settings/sound/RingerVolumeFragment;->aqQ:[I
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 344
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/settings/sound/RingerVolumeFragment;->uu()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqN:[Lcom/android/settings/sound/E;
    ...
    .line 146
    iget-object v8, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqN:[Lcom/android/settings/sound/E;
    ...
    .line 155
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqT:[Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqP:[I
    ...
    .line 149
    :cond_0
    iget-object v0, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqN:[Lcom/android/settings/sound/E;
    ...
    sget-object v4, Lcom/android/settings/sound/RingerVolumeFragment;->aqQ:[I
    ...
    iput-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqV:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqV:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqW:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/android/settings/sound/RingerVolumeFragment;->aqW:Landroid/content/BroadcastReceiver;
...
.method uv()V
    ...
    invoke-virtual {v1}, Lcom/android/settings/sound/E;->ux()V
