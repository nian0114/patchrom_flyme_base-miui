...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/d/c;->ig:Lcom/android/settings/search/l;
...
.method static synthetic a(Lcom/android/settings/d/c;)Lcom/android/settings/d/f;
    ...
    .prologue
    .line 50
    iget-object v0, p0, Lcom/android/settings/d/c;->hF:Lcom/android/settings/d/f;
...
.method private bH(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/settings/d/c;->ahU:Landroid/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 100
    iget-object v0, p0, Lcom/android/settings/d/c;->ahV:Landroid/preference/PreferenceCategory;
    ...
    iget-object v0, p0, Lcom/android/settings/d/c;->je:Landroid/net/wifi/WifiManager;
    ...
    .line 104
    iget-object v2, p0, Lcom/android/settings/d/c;->ahV:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings/d/c;->ahW:Landroid/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/d/c;->gO:Landroid/net/NetworkPolicyManager;
    ...
    iput-object v0, p0, Lcom/android/settings/d/c;->je:Landroid/net/wifi/WifiManager;

    .line 81
    new-instance v0, Lcom/android/settings/d/f;

    iget-object v2, p0, Lcom/android/settings/d/c;->gO:Landroid/net/NetworkPolicyManager;

    invoke-direct {v0, v2}, Lcom/android/settings/d/f;-><init>(Landroid/net/NetworkPolicyManager;)V

    iput-object v0, p0, Lcom/android/settings/d/c;->hF:Lcom/android/settings/d/f;
    ...
    iput-object v0, p0, Lcom/android/settings/d/c;->ahU:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/d/c;->ahV:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings/d/c;->ahW:Landroid/preference/Preference;

    .line 89
    invoke-direct {p0, v1}, Lcom/android/settings/d/c;->bH(Landroid/content/Context;)V
