...
# instance fields
.field private alJ:Landroid/preference/Preference;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/notification/ZenModeSettings;->ig:Lcom/android/settings_ex/search/l;
...
.method static synthetic bT(Landroid/content/Context;)Landroid/util/SparseArray;
    ...
    .prologue
    .line 35
    invoke-static {p0}, Lcom/android/settings_ex/notification/ZenModeSettings;->bS(Landroid/content/Context;)Landroid/util/SparseArray;
...
.method private pX()V
    ...
    .prologue
    .line 81
    invoke-direct {p0}, Lcom/android/settings_ex/notification/ZenModeSettings;->sW()V
...
.method private sW()V
    ...
    .prologue
    .line 85
    iget-object v0, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->aaj:Landroid/service/notification/ZenModeConfig;
    ...
    .line 87
    iget-object v2, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->aaj:Landroid/service/notification/ZenModeConfig;

    iget-boolean v2, v2, Landroid/service/notification/ZenModeConfig;->allowReminders:Z

    const v3, 0x7f0c0aa8

    invoke-direct {p0, v1, v2, v3}, Lcom/android/settings_ex/notification/ZenModeSettings;->a(Ljava/lang/String;ZI)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0, v2}, Lcom/android/settings_ex/notification/ZenModeSettings;->a(Ljava/lang/String;ZI)Ljava/lang/String;

    move-result-object v0

    .line 90
    iget-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->aaj:Landroid/service/notification/ZenModeConfig;

    iget-boolean v1, v1, Landroid/service/notification/ZenModeConfig;->allowMessages:Z

    const v2, 0x7f0c0aa2

    invoke-direct {p0, v0, v1, v2}, Lcom/android/settings_ex/notification/ZenModeSettings;->a(Ljava/lang/String;ZI)Ljava/lang/String;

    move-result-object v0

    .line 91
    iget-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->alJ:Landroid/preference/Preference;
...
.method public getName()Ljava/lang/String;
    ...
    .prologue
    .line 43
    const-class v0, Lcom/android/settings_ex/notification/ZenModeSettings;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->alJ:Landroid/preference/Preference;

    .line 54
    iget-object v0, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/settings_ex/notification/ZenModeSettings;->bU(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/notification/ZenModeSettings;->U(Ljava/lang/String;)V
...
.method public onResume()V
    ...
    .line 62
    invoke-direct {p0}, Lcom/android/settings_ex/notification/ZenModeSettings;->pX()V
