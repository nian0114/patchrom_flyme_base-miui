...
.method public static a(Landroid/content/pm/ServiceInfo;)Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;
    ...
    iput-object v4, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->alZ:Landroid/content/ComponentName;

    .line 117
    const-string v4, "android.settings.ZEN_MODE_EXTERNAL_RULE_SETTINGS"

    iput-object v4, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->alX:Ljava/lang/String;

    .line 118
    iput-object v1, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->alW:Ljava/lang/String;
    ...
    iput-object v1, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->alY:Landroid/net/Uri;
    ...
    iput-object v1, v0, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->ama:Landroid/content/ComponentName;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alm:Landroid/service/notification/ZenModeConfig$ZenRule;
...
.method protected sL()V
    ...
    iget-object v3, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alm:Landroid/service/notification/ZenModeConfig$ZenRule;
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alb:Landroid/preference/Preference;

    .line 75
    if-nez v1, :cond_3

    .line 76
    iget-object v2, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alb:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alc:Landroid/preference/Preference;

    .line 82
    if-eqz v1, :cond_2

    iget-object v0, v1, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->ama:Landroid/content/ComponentName;

    if-nez v0, :cond_4

    .line 83
    :cond_2
    iget-object v0, p0, Lcom/android/settings/notification/ZenModeExternalRuleSettings;->alc:Landroid/preference/Preference;
    ...
    iget-object v3, v1, Lcom/android/settings/notification/ZenRuleNameDialog$RuleInfo;->alW:Ljava/lang/String;
