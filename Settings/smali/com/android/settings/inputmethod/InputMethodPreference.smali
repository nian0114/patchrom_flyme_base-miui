...
# instance fields
.field private final afZ:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

.field private final agm:Z

.field private final agn:Lcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;ZZLcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;)V
    ...
    .line 94
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setPersistent(Z)V
    ...
    .line 96
    iput-boolean p4, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->ago:Z

    .line 97
    iput-object p5, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->agn:Lcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 110
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setIntent(Landroid/content/Intent;)V

    .line 117
    :goto_0
    invoke-static {p1}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->bB(Landroid/content/Context;)Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->afZ:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->afZ:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

    invoke-virtual {v1, p2, p1}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->b(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    :cond_1
    iput-boolean v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->agm:Z
    ...
    .line 115
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setIntent(Landroid/content/Intent;)V

    goto :goto_0
.end method

.method static synthetic b(Lcom/android/settings_ex/inputmethod/InputMethodPreference;)Lcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;
    .locals 1

    .prologue
    .line 52
    iget-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->agn:Lcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;
...
.method private c(Landroid/view/inputmethod/InputMethodInfo;)V
    ...
    new-instance v2, Lcom/android/settings_ex/inputmethod/InputMethodPreference$2;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference$2;-><init>(Lcom/android/settings_ex/inputmethod/InputMethodPreference;)V
...
.method static synthetic c(Lcom/android/settings_ex/inputmethod/InputMethodPreference;)V
    .locals 0
...
.method static synthetic d(Lcom/android/settings_ex/inputmethod/InputMethodPreference;)V
    .locals 0
...
.method private rt()Landroid/view/inputmethod/InputMethodManager;
    .locals 2
...
.method private ru()Ljava/lang/String;
    ...
    .line 201
    iget-boolean v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->ago:Z
    ...
    .line 204
    :cond_0
    invoke-direct {p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->rt()Landroid/view/inputmethod/InputMethodManager;
...
# virtual methods
.method a(Lcom/android/settings_ex/inputmethod/InputMethodPreference;Ljava/text/Collator;)I
    .locals 5
    ...
    .line 253
    :cond_1
    iget-boolean v2, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->agm:Z

    iget-boolean v3, p1, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->agm:Z
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 138
    invoke-direct {p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->rr()Z
    ...
    invoke-interface {v0, p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference$OnSavePreferenceListener;->a(Lcom/android/settings_ex/inputmethod/InputMethodPreference;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->c(Landroid/view/inputmethod/InputMethodInfo;)V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 176
    sget-object v2, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->TAG:Ljava/lang/String;
...
.method public rq()Landroid/view/inputmethod/InputMethodInfo;
    .locals 1
...
.method rs()V
    ...
    .prologue
    .line 186
    iget-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->afZ:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->mImi:Landroid/view/inputmethod/InputMethodInfo;

    invoke-virtual {p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->a(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->d(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    .line 192
    invoke-direct {p0}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->ru()Ljava/lang/String;
