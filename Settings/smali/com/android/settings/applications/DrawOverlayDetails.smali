...
.field private Im:Lcom/android/settings/applications/AppStateOverlayBridge;

.field private In:Landroid/preference/Preference;

.field private Io:Landroid/preference/Preference;

.field private Ip:Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/applications/DrawOverlayDetails;->Il:[I
...
.method public static a(Landroid/content/Context;Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 194
    invoke-virtual {p1}, Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;->jS()Z
...
.method private am(Z)V
    ...
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Fl:Landroid/content/pm/PackageInfo;
...
.method protected jH()Z
    ...
    .prologue
    .line 160
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Im:Lcom/android/settings/applications/AppStateOverlayBridge;

    iget-object v1, p0, Lcom/android/settings/applications/DrawOverlayDetails;->mPackageName:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Fl:Landroid/content/pm/PackageInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Ip:Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;

    .line 163
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Ip:Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;

    invoke-virtual {v0}, Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;->jS()Z
    ...
    iget-object v2, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Ip:Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;

    iget-boolean v2, v2, Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;->Gr:Z

    invoke-virtual {v1, v2}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 167
    iget-object v1, p0, Lcom/android/settings/applications/DrawOverlayDetails;->In:Landroid/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Fj:Lcom/android/b/a/a;
    ...
    iput-object v1, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Im:Lcom/android/settings/applications/AppStateOverlayBridge;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->In:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Io:Landroid/preference/Preference;
    ...
    .line 104
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->In:Landroid/preference/Preference;
    ...
    .line 105
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Io:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->DF:Landroid/content/Intent;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/android/settings/applications/DrawOverlayDetails;->Ip:Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;

    invoke-virtual {v3}, Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;->jS()Z
    ...
    invoke-virtual {v2}, Lcom/android/settings/applications/AppStateOverlayBridge$OverlayState;->jS()Z
    ...
    .line 135
    invoke-virtual {p0}, Lcom/android/settings/applications/DrawOverlayDetails;->jH()Z
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 118
    iget-object v0, p0, Lcom/android/settings/applications/DrawOverlayDetails;->DF:Landroid/content/Intent;
    ...
    iget-object v1, p0, Lcom/android/settings/applications/DrawOverlayDetails;->DF:Landroid/content/Intent;
    ...
    iget-object v3, p0, Lcom/android/settings/applications/DrawOverlayDetails;->DF:Landroid/content/Intent;
