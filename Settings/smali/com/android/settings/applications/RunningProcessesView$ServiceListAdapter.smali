...
# instance fields
.field final Hz:Lcom/android/settings/applications/RunningState;

.field NE:Ljava/util/ArrayList;

.field final synthetic NF:Lcom/android/settings/applications/RunningProcessesView;
...
.method constructor <init>(Lcom/android/settings/applications/RunningProcessesView;Lcom/android/settings/applications/RunningState;)V
    ...
    .prologue
    .line 234
    iput-object p1, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NF:Lcom/android/settings/applications/RunningProcessesView;
    ...
    .line 235
    iput-object p2, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Hz:Lcom/android/settings/applications/RunningState;
    ...
    .line 238
    invoke-virtual {p0}, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->lq()V
...
.method au(Z)V
    ...
    .prologue
    .line 242
    iget-boolean v0, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Nj:Z

    if-eq v0, p1, :cond_0

    .line 243
    iput-boolean p1, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Nj:Z

    .line 244
    iget-object v0, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Hz:Lcom/android/settings/applications/RunningState;
    ...
    .line 246
    iget-object v0, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NF:Lcom/android/settings/applications/RunningProcessesView;
...
.method public c(Landroid/view/View;I)V
    ...
    .line 328
    iget-object v3, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Hz:Lcom/android/settings/applications/RunningState;

    iget-object v4, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NF:Lcom/android/settings/applications/RunningProcessesView;
    ...
    .line 329
    iget-object v1, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NF:Lcom/android/settings/applications/RunningProcessesView;

    iget-object v1, v1, Lcom/android/settings/applications/RunningProcessesView;->MU:Ljava/util/HashMap;
...
.method public isEnabled(I)Z
    ...
    iget-boolean v0, v0, Lcom/android/settings/applications/RunningState$MergedItem;->ON:Z
...
.method lq()V
    ...
    .line 258
    :goto_0
    iget-object v1, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NE:Ljava/util/ArrayList;

    if-eq v1, v0, :cond_0

    .line 259
    iput-object v0, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->NE:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/settings/applications/RunningProcessesView$ServiceListAdapter;->Hz:Lcom/android/settings/applications/RunningState;
