...
.method private constructor <init>(Lcom/android/settings/applications/InstalledAppDetails;)V
    ...
    .prologue
    .line 844
    iput-object p1, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;
...
.method protected a(Lcom/android/settings/applications/ProcStatsPackageEntry;)V
    ...
    .line 872
    iget-object v0, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;
    ...
    iput-object p1, v0, Lcom/android/settings/applications/InstalledAppDetails;->IP:Lcom/android/settings/applications/ProcStatsPackageEntry;
    ...
    .line 878
    iget-wide v0, p1, Lcom/android/settings/applications/ProcStatsPackageEntry;->LD:D

    iget-wide v2, p1, Lcom/android/settings/applications/ProcStatsPackageEntry;->Lz:D

    invoke-static {v0, v1, v2, v3}, Ljava/lang/Math;->max(DD)D

    move-result-wide v0

    iget-object v2, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;

    iget-object v2, v2, Lcom/android/settings/applications/InstalledAppDetails;->IO:Lcom/android/settings/applications/ProcStatsData;

    invoke-virtual {v2}, Lcom/android/settings/applications/ProcStatsData;->lc()Lcom/android/settings/applications/ProcStatsData$MemInfo;

    move-result-object v2

    iget-wide v2, v2, Lcom/android/settings/applications/ProcStatsData$MemInfo;->Ls:D
    ...
    iget-object v3, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;

    const v4, 0x7f0c0b57

    new-array v5, v5, [Ljava/lang/Object;

    iget-object v6, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;
    ...
    iget-object v1, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;
...
.method protected varargs e([Ljava/lang/Void;)Lcom/android/settings/applications/ProcStatsPackageEntry;
    ...
    iget-object v0, v0, Lcom/android/settings/applications/InstalledAppDetails;->Fl:Landroid/content/pm/PackageInfo;
    ...
    iget-object v0, v0, Lcom/android/settings/applications/InstalledAppDetails;->IO:Lcom/android/settings/applications/ProcStatsData;
    ...
    iput-object v1, v0, Lcom/android/settings/applications/InstalledAppDetails;->IO:Lcom/android/settings/applications/ProcStatsData;
    ...
    .line 860
    iget-object v1, v0, Lcom/android/settings/applications/ProcStatsPackageEntry;->HL:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/settings/applications/InstalledAppDetails$MemoryUpdater;->IS:Lcom/android/settings/applications/InstalledAppDetails;

    iget-object v5, v5, Lcom/android/settings/applications/InstalledAppDetails;->Fl:Landroid/content/pm/PackageInfo;
