...
.field private static bfh:I

.field private static bfi:I

.field private static bfj:Ljava/util/concurrent/BlockingQueue;

.field private static bfk:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method static constructor <clinit>()V
    ...
    .line 27
    sput v0, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfh:I

    .line 28
    const/4 v0, 0x2

    sput v0, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfi:I
    ...
    sput-object v0, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfj:Ljava/util/concurrent/BlockingQueue;

    .line 30
    new-instance v1, Ljava/util/concurrent/ThreadPoolExecutor;

    sget v2, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfg:I

    sget v3, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfh:I

    sget v0, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfi:I

    int-to-long v4, v0

    sget-object v6, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    sget-object v7, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfj:Ljava/util/concurrent/BlockingQueue;

    invoke-direct/range {v1 .. v7}, Ljava/util/concurrent/ThreadPoolExecutor;-><init>(IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;)V

    sput-object v1, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfk:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method private ea(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/mipush/sdk/o;->Gg()Z
    ...
    invoke-virtual {v0}, Lcom/xiaomi/mipush/sdk/a;->FP()Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 34
    sget-object v0, Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;->bfk:Ljava/util/concurrent/ThreadPoolExecutor;
