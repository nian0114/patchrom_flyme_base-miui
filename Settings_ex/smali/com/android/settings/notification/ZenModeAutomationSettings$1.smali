...
.method constructor <init>(Lcom/android/settings_ex/notification/ZenModeAutomationSettings;Landroid/content/Context;Lcom/android/settings_ex/notification/ServiceListing;Ljava/lang/String;Landroid/util/ArraySet;)V
    ...
    .prologue
    .line 97
    iput-object p1, p0, Lcom/android/settings_ex/notification/ZenModeAutomationSettings$1;->akJ:Lcom/android/settings_ex/notification/ZenModeAutomationSettings;
...
# virtual methods
.method public a(Ljava/lang/String;Lcom/android/settings_ex/notification/ZenRuleNameDialog$RuleInfo;)V
    .locals 5
    ...
    .line 100
    iget-object v0, p0, Lcom/android/settings_ex/notification/ZenModeAutomationSettings$1;->akJ:Lcom/android/settings_ex/notification/ZenModeAutomationSettings;
    ...
    .line 105
    iget-object v1, p2, Lcom/android/settings_ex/notification/ZenRuleNameDialog$RuleInfo;->alY:Landroid/net/Uri;

    iput-object v1, v0, Landroid/service/notification/ZenModeConfig$ZenRule;->conditionId:Landroid/net/Uri;

    .line 106
    iget-object v1, p2, Lcom/android/settings_ex/notification/ZenRuleNameDialog$RuleInfo;->alZ:Landroid/content/ComponentName;

    iput-object v1, v0, Landroid/service/notification/ZenModeConfig$ZenRule;->component:Landroid/content/ComponentName;

    .line 107
    iget-object v1, p0, Lcom/android/settings_ex/notification/ZenModeAutomationSettings$1;->akJ:Lcom/android/settings_ex/notification/ZenModeAutomationSettings;

    iget-object v1, v1, Lcom/android/settings_ex/notification/ZenModeAutomationSettings;->aaj:Landroid/service/notification/ZenModeConfig;
    ...
    .line 110
    iget-object v3, p0, Lcom/android/settings_ex/notification/ZenModeAutomationSettings$1;->akJ:Lcom/android/settings_ex/notification/ZenModeAutomationSettings;

    invoke-virtual {v3, v1}, Lcom/android/settings_ex/notification/ZenModeAutomationSettings;->a(Landroid/service/notification/ZenModeConfig;)Z
    ...
    iget-object v3, p2, Lcom/android/settings_ex/notification/ZenRuleNameDialog$RuleInfo;->alX:Ljava/lang/String;

    iget-object v4, p2, Lcom/android/settings_ex/notification/ZenRuleNameDialog$RuleInfo;->ama:Landroid/content/ComponentName;

    iget-object v0, v0, Landroid/service/notification/ZenModeConfig$ZenRule;->name:Ljava/lang/String;

    invoke-static {v1, v3, v4, v2, v0}, Lcom/android/settings_ex/notification/ZenModeAutomationSettings;->a(Lcom/android/settings_ex/notification/ZenModeAutomationSettings;Ljava/lang/String;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;)V
