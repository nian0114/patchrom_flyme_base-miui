.class Lcom/android/settings_ex/bootloader/c;
.super Ljava/lang/Object;
.source "CloudDeviceStatus.java"


# static fields
.field private static final SA:Landroid/net/Uri;

.field private static SB:Lcom/android/settings_ex/bootloader/d;

.field private static final Sz:Landroid/net/Uri;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/bootloader/c;->Sz:Landroid/net/Uri;

    .line 35
    sget-object v0, Lcom/android/settings_ex/bootloader/c;->Sz:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/android/settings_ex/bootloader/c;->SA:Landroid/net/Uri;

    .line 38
    new-instance v0, Lcom/android/settings_ex/bootloader/d;

    invoke-direct {v0}, Lcom/android/settings_ex/bootloader/d;-><init>()V

    sput-object v0, Lcom/android/settings_ex/bootloader/c;->SB:Lcom/android/settings_ex/bootloader/d;
...
.method private static a(Landroid/content/Context;Ljava/util/Map;)V
    ...
    .line 207
    :try_start_0
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/Utils;->aE(Landroid/content/Context;)Lcom/xiaomi/accountsdk/account/data/ExtendedAuthToken;

    move-result-object v0

    .line 208
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/Utils;->aF(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_end_0
    .catch Lcom/android/settings_ex/bootloader/Utils$AccountExcepiton; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Lmiui/cloud/net/XHttpClient$HttpResponse;)Z
    ...
    .line 92
    sget-object v0, Lcom/android/settings_ex/bootloader/c;->SB:Lcom/android/settings_ex/bootloader/d;

    iput v4, v0, Lcom/android/settings_ex/bootloader/d;->SC:I
    ...
    iput v2, v0, Lcom/android/settings_ex/bootloader/d;->SC:I
    ...
    .line 110
    :cond_3
    sget-object v2, Lcom/android/settings_ex/bootloader/c;->SB:Lcom/android/settings_ex/bootloader/d;

    const/4 v3, 0x4

    iput v3, v2, Lcom/android/settings_ex/bootloader/d;->SC:I
    ...
    iput-object v0, v2, Lcom/android/settings_ex/bootloader/d;->SD:Ljava/lang/String;
    :try_end_0
...
.method private static aA(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 178
    sget-object v1, Lcom/android/settings_ex/bootloader/c;->SA:Landroid/net/Uri;
...
.method public static ay(Landroid/content/Context;)Lcom/android/settings_ex/bootloader/d;
    .locals 6
    ...
    .line 48
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/c;->az(Landroid/content/Context;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 51
    new-instance v0, Lcom/android/settings_ex/bootloader/Utils$ParameterException;

    const-string v1, "get paramter error: fid"

    invoke-direct {v0, v1}, Lcom/android/settings_ex/bootloader/Utils$ParameterException;-><init>(Ljava/lang/String;)V

    throw v0

    .line 56
    :cond_0
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/Utils;->aC(Landroid/content/Context;)Ljava/lang/String;
    ...
    iput v1, v0, Lcom/android/settings_ex/bootloader/d;->SC:I
    ...
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/Utils;->getDeviceId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/settings_ex/bootloader/c;->aA(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 67
    invoke-static {v0}, Lcom/android/settings_ex/bootloader/c;->a(Ljava/util/Map;)[B
    ...
    invoke-static {v2}, Lcom/android/settings_ex/bootloader/Utils;->b([B)Ljava/lang/String;
    ...
    .line 73
    invoke-static {p0, v1}, Lcom/android/settings_ex/bootloader/c;->a(Landroid/content/Context;Ljava/util/Map;)V
    ...
    .line 78
    invoke-static {v0}, Lcom/android/settings_ex/bootloader/c;->a(Lmiui/cloud/net/XHttpClient$HttpResponse;)Z
...
.method private static az(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lcom/android/settings_ex/bootloader/Utils;->a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
