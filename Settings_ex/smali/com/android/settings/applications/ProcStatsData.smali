...
# static fields
.field private static Lc:Lcom/android/internal/app/ProcessStats;
...
.field private Le:Lcom/android/internal/app/IProcessStats;
...
.field private Li:Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcStatsData;->Lk:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->i:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Le:Lcom/android/internal/app/IProcessStats;

    .line 77
    sget-object v0, Lcom/android/internal/app/ProcessStats;->ALL_MEM_ADJ:[I

    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lg:[I

    .line 78
    sget-object v0, Lcom/android/internal/app/ProcessStats;->BACKGROUND_PROC_STATES:[I

    iput-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lh:[I

    .line 79
    if-eqz p2, :cond_0

    .line 80
    sget-object v0, Lcom/android/settings_ex/applications/ProcStatsData;->Lc:Lcom/android/internal/app/ProcessStats;
...
.method private a(Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$TotalMemoryUseCollection;J)Lcom/android/settings_ex/applications/ProcStatsPackageEntry;
    .locals 12
    ...
    iget-wide v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Ld:J

    invoke-direct {v8, v0, v2, v3}, Lcom/android/settings_ex/applications/ProcStatsPackageEntry;-><init>(Ljava/lang/String;J)V
    ...
    iget-wide v4, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Ld:J

    iget-wide v6, p3, Lcom/android/internal/app/ProcessStats$TotalMemoryUseCollection;->sysMemNativeWeight:D

    iget-wide v10, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Ld:J
    ...
    .line 192
    iget-object v1, p0, Lcom/android/settings_ex/applications/ProcStatsData;->i:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->mStats:Lcom/android/internal/app/ProcessStats;

    sget-object v5, Lcom/android/settings_ex/applications/ProcStatsData;->Lk:Ljava/util/Comparator;

    iget-boolean v6, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lf:Z

    move-object v3, p1

    move-object v4, p2

    invoke-virtual/range {v0 .. v6}, Lcom/android/settings_ex/applications/ProcStatsEntry;->a(Landroid/content/pm/PackageManager;Lcom/android/internal/app/ProcessStats;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Ljava/util/Comparator;Z)V

    .line 193
    invoke-virtual {v8, v0}, Lcom/android/settings_ex/applications/ProcStatsPackageEntry;->a(Lcom/android/settings_ex/applications/ProcStatsEntry;)V
...
.method private a(Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;)Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Lcom/android/settings_ex/applications/ProcStatsData;->mStats:Lcom/android/internal/app/ProcessStats;
    ...
    iget-boolean v7, v0, Lcom/android/settings_ex/applications/ProcStatsData;->Lf:Z
    ...
    .line 245
    iget-wide v4, v2, Lcom/android/settings_ex/applications/ProcStatsEntry;->LD:D
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings_ex/applications/ProcStatsEntry;->addPackage(Ljava/lang/String;)V
    ...
    .line 282
    invoke-virtual {v6, v5}, Lcom/android/settings_ex/applications/ProcStatsEntry;->a(Lcom/android/internal/app/ProcessStats$ServiceState;)V
...
.method private a(Ljava/util/ArrayList;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;)V
    ...
    .line 173
    iget-object v1, v0, Lcom/android/settings_ex/applications/ProcStatsEntry;->LE:Ljava/lang/String;
    ...
    .line 175
    new-instance v1, Lcom/android/settings_ex/applications/ProcStatsPackageEntry;

    iget-object v2, v0, Lcom/android/settings_ex/applications/ProcStatsEntry;->LE:Ljava/lang/String;

    iget-wide v4, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Ld:J

    invoke-direct {v1, v2, v4, v5}, Lcom/android/settings_ex/applications/ProcStatsPackageEntry;-><init>(Ljava/lang/String;J)V
    ...
    .line 177
    iget-object v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lj:Ljava/util/ArrayList;

    invoke-virtual {v2, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 179
    :cond_0
    invoke-virtual {v1, v0}, Lcom/android/settings_ex/applications/ProcStatsPackageEntry;->a(Lcom/android/settings_ex/applications/ProcStatsEntry;)V
...
.method private load()V
    ...
    .line 298
    :try_start_0
    iget-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Le:Lcom/android/internal/app/IProcessStats;

    iget-wide v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->mDuration:J
    ...
    iput-object v1, p0, Lcom/android/settings_ex/applications/ProcStatsData;->mStats:Lcom/android/internal/app/ProcessStats;
...
.method public as(Z)V
    ...
    .line 138
    :cond_0
    invoke-direct {p0}, Lcom/android/settings_ex/applications/ProcStatsData;->load()V
    ...
    iput-object v1, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lj:Ljava/util/ArrayList;
    ...
    iput-wide v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Ld:J
    ...
    iget-object v2, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lg:[I
    ...
    .line 152
    new-instance v1, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;-><init>(Landroid/content/Context;Lcom/android/internal/app/ProcessStats$TotalMemoryUseCollection;JLcom/android/settings_ex/applications/ProcStatsData$1;)V

    iput-object v1, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Li:Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lh:[I
    ...
    iget-object v4, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lg:[I
    ...
    .line 159
    invoke-direct {p0, v1, v2}, Lcom/android/settings_ex/applications/ProcStatsData;->a(Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;)Ljava/util/ArrayList;

    move-result-object v0

    invoke-direct {p0, v0, v1, v2}, Lcom/android/settings_ex/applications/ProcStatsData;->a(Ljava/util/ArrayList;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;)V

    .line 161
    iget-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Li:Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;

    iget-wide v4, v0, Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;->Lo:J

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/settings_ex/applications/ProcStatsData;->a(Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$ProcessDataCollection;Lcom/android/internal/app/ProcessStats$TotalMemoryUseCollection;J)Lcom/android/settings_ex/applications/ProcStatsPackageEntry;

    move-result-object v0

    .line 163
    iget-object v1, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lj:Ljava/util/ArrayList;
...
.method public la()V
    ...
    sput-object v0, Lcom/android/settings_ex/applications/ProcStatsData;->Lc:Lcom/android/internal/app/ProcessStats;
...
.method public lc()Lcom/android/settings_ex/applications/ProcStatsData$MemInfo;
    .locals 1
...
.method public ld()Ljava/util/List;
    ...
    .prologue
    .line 133
    iget-object v0, p0, Lcom/android/settings_ex/applications/ProcStatsData;->Lj:Ljava/util/ArrayList;
...
.method public setDuration(J)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/applications/ProcStatsData;->as(Z)V
