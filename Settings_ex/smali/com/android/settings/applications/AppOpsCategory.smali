...
# instance fields
.field Fx:Lcom/android/settings_ex/applications/AppOpsState;

.field Fy:Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;
...
.method private jJ()V
    ...
    iget-object v1, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fz:Ljava/lang/String;
...
.method public a(Landroid/content/Loader;Ljava/util/List;)V
    ...
    .line 360
    iget-object v0, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fy:Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;

    invoke-virtual {v0, p2}, Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;->s(Ljava/util/List;)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fx:Lcom/android/settings_ex/applications/AppOpsState;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fy:Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fx:Lcom/android/settings_ex/applications/AppOpsState;
...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    check-cast v0, Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;

    .line 355
    :cond_0
    new-instance v1, Lcom/android/settings_ex/applications/AppOpsCategory$AppListLoader;

    invoke-virtual {p0}, Lcom/android/settings_ex/applications/AppOpsCategory;->getActivity()Landroid/app/Activity;

    move-result-object v2

    iget-object v3, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fx:Lcom/android/settings_ex/applications/AppOpsState;

    invoke-direct {v1, v2, v3, v0}, Lcom/android/settings_ex/applications/AppOpsCategory$AppListLoader;-><init>(Landroid/content/Context;Lcom/android/settings_ex/applications/AppOpsState;Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;)V
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {v0, p3}, Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;->az(I)Lcom/android/settings_ex/applications/AppOpsState$AppOpEntry;
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/applications/AppOpsState$AppEntry;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;

    move-result-object v0

    iget-object v0, v0, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    iput-object v0, p0, Lcom/android/settings_ex/applications/AppOpsCategory;->Fz:Ljava/lang/String;

    .line 345
    invoke-direct {p0}, Lcom/android/settings_ex/applications/AppOpsCategory;->jJ()V
...
.method public synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/settings_ex/applications/AppOpsCategory;->a(Landroid/content/Loader;Ljava/util/List;)V
...
.method public onLoaderReset(Landroid/content/Loader;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/applications/AppOpsCategory$AppListAdapter;->s(Ljava/util/List;)V
