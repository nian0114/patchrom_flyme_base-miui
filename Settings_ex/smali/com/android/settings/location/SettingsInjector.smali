...
# instance fields
.field private final ahB:Ljava/util/Set;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/location/SettingsInjector;->ahB:Ljava/util/Set;
...
.method static synthetic a(Lcom/android/settings_ex/location/SettingsInjector;)Landroid/content/Context;
    .locals 1
...
.method private a(Ljava/util/List;Lcom/android/settings_ex/location/InjectedSetting;)Landroid/preference/Preference;
    .locals 5
    ...
    .line 269
    iget-object v2, p2, Lcom/android/settings_ex/location/InjectedSetting;->packageName:Ljava/lang/String;

    iget v3, p2, Lcom/android/settings_ex/location/InjectedSetting;->iconId:I
    ...
    .line 270
    iget-object v3, p2, Lcom/android/settings_ex/location/InjectedSetting;->BY:Landroid/os/UserHandle;
    ...
    .line 271
    iget-object v3, p2, Lcom/android/settings_ex/location/InjectedSetting;->title:Ljava/lang/String;

    iget-object v4, p2, Lcom/android/settings_ex/location/InjectedSetting;->BY:Landroid/os/UserHandle;
    ...
    .line 277
    :cond_0
    new-instance v3, Lcom/android/settings_ex/DimmableIconPreference;

    iget-object v4, p0, Lcom/android/settings_ex/location/SettingsInjector;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4, v0}, Lcom/android/settings_ex/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 278
    iget-object v0, p2, Lcom/android/settings_ex/location/InjectedSetting;->title:Ljava/lang/String;
    ...
    .line 281
    new-instance v0, Lcom/android/settings_ex/location/SettingsInjector$ServiceSettingClickedListener;

    invoke-direct {v0, p0, p2}, Lcom/android/settings_ex/location/SettingsInjector$ServiceSettingClickedListener;-><init>(Lcom/android/settings_ex/location/SettingsInjector;Lcom/android/settings_ex/location/InjectedSetting;)V
...
.method private static a(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings_ex/location/InjectedSetting;
    .locals 7
    ...
    invoke-static {v4, v5, p1, v3, v0}, Lcom/android/settings_ex/location/SettingsInjector;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;Landroid/content/res/Resources;Landroid/util/AttributeSet;)Lcom/android/settings_ex/location/InjectedSetting;
    :try_end_3
...
.method private static a(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;Landroid/content/res/Resources;Landroid/util/AttributeSet;)Lcom/android/settings_ex/location/InjectedSetting;
    .locals 7
    ...
    .line 220
    invoke-static/range {v0 .. v5}, Lcom/android/settings_ex/location/InjectedSetting;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/UserHandle;Ljava/lang/String;)Lcom/android/settings_ex/location/InjectedSetting;
    :try_end_0
...
.method private b(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .line 128
    :try_start_0
    invoke-static {v0, p1, v2}, Lcom/android/settings_ex/location/SettingsInjector;->a(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings_ex/location/InjectedSetting;
...
.method static synthetic b(Lcom/android/settings_ex/location/SettingsInjector;)Ljava/util/Set;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Lcom/android/settings_ex/location/SettingsInjector;->ahB:Ljava/util/Set;

    return-object v0
.end method

.method static synthetic c(Lcom/android/settings_ex/location/SettingsInjector;)Landroid/os/Handler;
    .locals 1
...
.method public cs(I)Ljava/util/List;
    ...
    .line 241
    :cond_0
    invoke-direct {p0, v0}, Lcom/android/settings_ex/location/SettingsInjector;->b(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .line 243
    invoke-direct {p0, v3, v0}, Lcom/android/settings_ex/location/SettingsInjector;->a(Ljava/util/List;Lcom/android/settings_ex/location/InjectedSetting;)Landroid/preference/Preference;

    move-result-object v6

    .line 244
    iget-object v7, p0, Lcom/android/settings_ex/location/SettingsInjector;->ahB:Ljava/util/Set;

    new-instance v8, Lcom/android/settings_ex/location/SettingsInjector$Setting;

    const/4 v9, 0x0

    invoke-direct {v8, p0, v0, v6, v9}, Lcom/android/settings_ex/location/SettingsInjector$Setting;-><init>(Lcom/android/settings_ex/location/SettingsInjector;Lcom/android/settings_ex/location/InjectedSetting;Landroid/preference/Preference;Lcom/android/settings_ex/location/SettingsInjector$1;)V
    ...
    .line 249
    :cond_2
    invoke-virtual {p0}, Lcom/android/settings_ex/location/SettingsInjector;->rO()V
...
.method public rO()V
    ...
    iget-object v2, p0, Lcom/android/settings_ex/location/SettingsInjector;->ahB:Ljava/util/Set;
