.class public Lcom/android/settings_ex/d/f;
.super Ljava/lang/Object;
.source "NetworkPolicyEditor.java"


# instance fields
.field private ahY:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/net/NetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/d/f;->ahY:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/d/f;->gO:Landroid/net/NetworkPolicyManager;
...
.method public a(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 100
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/d/f;->b(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 102
    invoke-static {p1}, Lcom/android/settings_ex/d/f;->d(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    .line 103
    iget-object v1, p0, Lcom/android/settings_ex/d/f;->ahY:Ljava/util/ArrayList;
...
.method public a(Landroid/net/NetworkTemplate;ILjava/lang/String;)V
    ...
    .prologue
    .line 155
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/d/f;->a(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 160
    invoke-virtual {p0}, Lcom/android/settings_ex/d/f;->rT()V
...
.method public a(Landroid/net/NetworkTemplate;Z)V
    ...
    .line 207
    iget-object v0, p0, Lcom/android/settings_ex/d/f;->ahY:Ljava/util/ArrayList;
    ...
    :cond_0
    :goto_0
    invoke-static {p1}, Lcom/android/settings_ex/d/f;->h(Landroid/net/NetworkTemplate;)Landroid/net/NetworkTemplate;

    move-result-object v2

    .line 227
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/d/f;->b(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public a([Landroid/net/NetworkPolicy;)V
    ...
    .prologue
    .line 91
    iget-object v0, p0, Lcom/android/settings_ex/d/f;->gO:Landroid/net/NetworkPolicyManager;
...
.method public c(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/d/f;->b(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public rT()V
    ...
    .line 81
    new-instance v1, Lcom/android/settings_ex/d/g;

    invoke-direct {v1, p0, v0}, Lcom/android/settings_ex/d/g;-><init>(Lcom/android/settings_ex/d/f;[Landroid/net/NetworkPolicy;)V

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/Void;

    invoke-virtual {v1, v0}, Lcom/android/settings_ex/d/g;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public read()V
    ...
    .line 56
    iget-object v2, p0, Lcom/android/settings_ex/d/f;->gO:Landroid/net/NetworkPolicyManager;
    ...
    .line 59
    iget-object v2, p0, Lcom/android/settings_ex/d/f;->ahY:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_1
    iget-object v6, p0, Lcom/android/settings_ex/d/f;->ahY:Ljava/util/ArrayList;
