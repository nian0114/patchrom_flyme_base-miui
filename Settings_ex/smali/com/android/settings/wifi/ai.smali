.class public Lcom/android/settings_ex/wifi/ai;
.super Ljava/lang/Object;
.source "WifiConfigForSupplicant.java"


# static fields
.field private static aDj:Lcom/android/settings_ex/wifi/ai;


# instance fields
.field private aDk:Lcom/android/internal/util/AsyncChannel;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/wifi/ai;->aDj:Lcom/android/settings_ex/wifi/ai;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/wifi/ai;->mService:Landroid/net/wifi/IWifiManager;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/wifi/ai;->aDk:Lcom/android/internal/util/AsyncChannel;

    .line 53
    iget-object v1, p0, Lcom/android/settings_ex/wifi/ai;->aDk:Lcom/android/internal/util/AsyncChannel;
    ...
    iget-object v0, p0, Lcom/android/settings_ex/wifi/ai;->mService:Landroid/net/wifi/IWifiManager;
...
.method private a(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    .line 124
    invoke-static {p1, v0}, Lcom/android/settings_ex/wifi/ak;->f(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 125
    invoke-static {v1, v0}, Lcom/android/settings_ex/wifi/ak;->a(Ljava/util/ArrayList;Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-static {p1, v1, v0, v4, v4}, Lcom/android/settings_ex/wifi/ak;->a(Landroid/content/Context;Ljava/util/ArrayList;IZI)V
...
.method private a(Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 170
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/ai;->cf(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 172
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/ai;->cg(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/android/settings_ex/wifi/ai;->a(Ljava/lang/String;[Ljava/lang/String;Ljava/util/BitSet;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/settings_ex/wifi/ai;->b([Ljava/lang/String;Ljava/lang/String;)I
...
.method private cc(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-direct {p0, v3, v1}, Lcom/android/settings_ex/wifi/ai;->a(Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;)V
...
.method private cd(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/android/settings_ex/wifi/ai;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
...
.method private cf(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 244
    invoke-direct {p0, p1}, Lcom/android/settings_ex/wifi/ai;->cg(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 246
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/ai;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
...
.method public static yi()Lcom/android/settings_ex/wifi/ai;
    .locals 2

    .prologue
    .line 61
    const-class v1, Lcom/android/settings_ex/wifi/ai;

    monitor-enter v1

    .line 62
    :try_start_0
    sget-object v0, Lcom/android/settings_ex/wifi/ai;->aDj:Lcom/android/settings_ex/wifi/ai;

    if-nez v0, :cond_0

    .line 63
    new-instance v0, Lcom/android/settings_ex/wifi/ai;

    invoke-direct {v0}, Lcom/android/settings_ex/wifi/ai;-><init>()V
...
.method public a(Landroid/content/Context;Ljava/io/FileDescriptor;)V
    ...
    .line 145
    invoke-direct {p0, v0, v3}, Lcom/android/settings_ex/wifi/ai;->a(Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;)V
    ...
    :cond_4
    :goto_2
    invoke-direct {p0, p1, v4}, Lcom/android/settings_ex/wifi/ai;->a(Landroid/content/Context;Ljava/util/ArrayList;)V
...
.method public ce(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/ai;->cd(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/ai;->cc(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
