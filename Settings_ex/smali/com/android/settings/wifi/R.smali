.class public Lcom/android/settings_ex/wifi/R;
...
.method public static a(Landroid/content/Context;Lcom/android/b/e/a;)Ljava/lang/String;
    ...
    .line 25
    invoke-virtual {p1}, Lcom/android/b/e/a;->AL()Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/android/settings_ex/wifi/ak;->f(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 33
    invoke-static {}, Lcom/android/settings_ex/wifi/ai;->yi()Lcom/android/settings_ex/wifi/ai;

    move-result-object v1

    invoke-virtual {v1, v3}, Lcom/android/settings_ex/wifi/ai;->ce(Ljava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 47
    :cond_4
    invoke-static {v2, v0, v3}, Lcom/android/settings_ex/wifi/R;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Lcom/android/b/e/a;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 95
    invoke-static {p0, p1}, Lcom/android/settings_ex/wifi/R;->a(Landroid/content/Context;Lcom/android/b/e/a;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, v0}, Lcom/android/settings_ex/wifi/R;->B(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method public static d(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    .prologue
    .line 52
    invoke-static {p1}, Lcom/android/settings_ex/wifi/ac;->a(Landroid/net/wifi/WifiConfiguration;)I
    ...
    :cond_3
    :goto_2
    invoke-static {v0, v1, v2}, Lcom/android/settings_ex/wifi/R;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 86
    invoke-static {p0, p1}, Lcom/android/settings_ex/wifi/R;->d(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
