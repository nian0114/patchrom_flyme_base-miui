...
# instance fields
.field private Cn:Landroid/preference/ListPreference;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cp:Z

    .line 62
    new-instance v0, Lcom/android/settings_ex/iI;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/iI;-><init>(Lcom/android/settings_ex/WifiCallingSettings;)V

    iput-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->xE:Landroid/telephony/PhoneStateListener;

    .line 132
    new-instance v0, Lcom/android/settings_ex/iJ;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/iJ;-><init>(Lcom/android/settings_ex/WifiCallingSettings;)V
...
.method static synthetic a(Lcom/android/settings_ex/WifiCallingSettings;)Landroid/widget/Switch;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->ta:Landroid/widget/Switch;
...
.method private a(Landroid/content/Context;ZI)V
    ...
    .prologue
    .line 245
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cn:Landroid/preference/ListPreference;

    invoke-static {p1, p3}, Lcom/android/settings_ex/WifiCallingSettings;->i(Landroid/content/Context;I)I
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/WifiCallingSettings;->iz()Z
    ...
    .line 250
    iget-object v1, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cn:Landroid/preference/ListPreference;
...
.method static synthetic a(Lcom/android/settings_ex/WifiCallingSettings;Landroid/content/Intent;)V
    .locals 0

    .prologue
    .line 45
    invoke-direct {p0, p1}, Lcom/android/settings_ex/WifiCallingSettings;->s(Landroid/content/Intent;)V
...
.method public a(Landroid/widget/Switch;Z)V
    ...
    .line 236
    invoke-direct {p0, v0, p2, v1}, Lcom/android/settings_ex/WifiCallingSettings;->a(Landroid/content/Context;ZI)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/WifiCallingSettings;->z()I
...
.method public getName()Ljava/lang/String;
    ...
    .prologue
    .line 91
    const-class v0, Lcom/android/settings_ex/WifiCallingSettings;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->me:Lcom/android/settings_ex/widget/SwitchBar;

    .line 101
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->me:Lcom/android/settings_ex/widget/SwitchBar;

    invoke-virtual {v0}, Lcom/android/settings_ex/widget/SwitchBar;->wQ()Lcom/android/settings_ex/widget/ToggleSwitch;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->ta:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Co:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/WifiCallingSettings;->Co:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroid/widget/ListView;->setEmptyView(Landroid/view/View;)V

    .line 106
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Co:Landroid/widget/TextView;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cn:Landroid/preference/ListPreference;
...
.method public onPause()V
    ...
    .line 214
    iget-boolean v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cp:Z

    if-eqz v0, :cond_0

    .line 215
    iput-boolean v3, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cp:Z

    .line 217
    const-string v0, "phone"

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/WifiCallingSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 218
    iget-object v2, p0, Lcom/android/settings_ex/WifiCallingSettings;->xE:Landroid/telephony/PhoneStateListener;
    ...
    .line 223
    :cond_0
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->mIntentReceiver:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 260
    iget-object v2, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cn:Landroid/preference/ListPreference;
    ...
    invoke-static {v1, v0}, Lcom/android/settings_ex/WifiCallingSettings;->i(Landroid/content/Context;I)I
...
.method public onResume()V
    ...
    .line 179
    iget-object v4, p0, Lcom/android/settings_ex/WifiCallingSettings;->xE:Landroid/telephony/PhoneStateListener;
    ...
    .line 183
    iput-boolean v1, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cp:Z
    ...
    .line 195
    :goto_0
    iget-object v1, p0, Lcom/android/settings_ex/WifiCallingSettings;->ta:Landroid/widget/Switch;
    ...
    .line 197
    iget-object v4, p0, Lcom/android/settings_ex/WifiCallingSettings;->Cn:Landroid/preference/ListPreference;
    ...
    .line 198
    invoke-direct {p0, v3, v0, v1}, Lcom/android/settings_ex/WifiCallingSettings;->a(Landroid/content/Context;ZI)V

    .line 200
    iget-object v0, p0, Lcom/android/settings_ex/WifiCallingSettings;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    iget-object v1, p0, Lcom/android/settings_ex/WifiCallingSettings;->mIntentFilter:Landroid/content/IntentFilter;
    ...
    .line 204
    invoke-direct {p0, v0}, Lcom/android/settings_ex/WifiCallingSettings;->s(Landroid/content/Intent;)V
