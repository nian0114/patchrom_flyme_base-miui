...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/CredentialStorage;->fU:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;

    .line 125
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/settings_ex/CredentialStorage;->fW:I

    .line 521
    return-void
.end method

.method static synthetic a(Lcom/android/settings_ex/CredentialStorage;I)I
    .locals 0

    .prologue
    .line 92
    iput p1, p0, Lcom/android/settings_ex/CredentialStorage;->fW:I

    return p1
.end method

.method static synthetic a(Lcom/android/settings_ex/CredentialStorage;)Landroid/security/KeyStore;
    .locals 1

    .prologue
    .line 92
    iget-object v0, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
...
.method private aR()V
    ...
    .line 166
    :cond_0
    sget-object v0, Lcom/android/settings_ex/aW;->fX:[I

    iget-object v1, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
    ...
    .line 168
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aS()V

    goto :goto_0

    .line 172
    :pswitch_1
    new-instance v0, Lcom/android/settings_ex/ba;

    invoke-direct {v0, p0, v2}, Lcom/android/settings_ex/ba;-><init>(Lcom/android/settings_ex/CredentialStorage;Lcom/android/settings_ex/aW;)V

    goto :goto_0

    .line 176
    :pswitch_2
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aT()Z
    ...
    .line 177
    new-instance v0, Lcom/android/settings_ex/aX;

    invoke-direct {v0, p0, v2}, Lcom/android/settings_ex/aX;-><init>(Lcom/android/settings_ex/CredentialStorage;Lcom/android/settings_ex/aW;)V

    goto :goto_0

    .line 180
    :cond_1
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aU()V
...
.method private aS()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/aX;-><init>(Lcom/android/settings_ex/CredentialStorage;Lcom/android/settings_ex/aW;)V
    ...
    .line 201
    :cond_1
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aW()Z
...
.method private aU()V
    ...
    .line 242
    iget-object v0, p0, Lcom/android/settings_ex/CredentialStorage;->fV:Landroid/os/Bundle;
    ...
    .line 246
    :cond_1
    iget-object v3, p0, Lcom/android/settings_ex/CredentialStorage;->fV:Landroid/os/Bundle;

    .line 247
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings_ex/CredentialStorage;->fV:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/settings_ex/CredentialStorage;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/CredentialStorage;->a([B)Z
    ...
    .line 281
    :goto_1
    iget-object v7, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
    ...
    .line 293
    iget-object v6, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/CredentialStorage;->dt:Landroid/security/KeyStore;
    ...
    .line 329
    :cond_9
    invoke-virtual {p0, v8}, Lcom/android/settings_ex/CredentialStorage;->setResult(I)V
...
.method private aV()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/CredentialStorage;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private aW()Z
    ...
    invoke-virtual {v1, v3, v0, v3}, Lcom/android/settings_ex/aH;->a(ILjava/lang/CharSequence;Z)Z
...
.method static synthetic access$400()[I
    ...
    .prologue
    .line 92
    sget-object v0, Lcom/android/settings_ex/CredentialStorage;->fU:[I

    return-object v0
.end method

.method static synthetic b(Lcom/android/settings_ex/CredentialStorage;)I
    .locals 1

    .prologue
    .line 92
    iget v0, p0, Lcom/android/settings_ex/CredentialStorage;->fW:I

    return v0
.end method

.method static synthetic c(Lcom/android/settings_ex/CredentialStorage;)V
    .locals 0
...
.method static synthetic d(Lcom/android/settings_ex/CredentialStorage;)V
    .locals 0

    .prologue
    .line 92
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aR()V
...
.method protected onResume()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/CredentialStorage;->setVisible(Z)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/aY;-><init>(Lcom/android/settings_ex/CredentialStorage;Lcom/android/settings_ex/aW;)V
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/CredentialStorage;->aV()Z
