...
#-----------------------------------------------------------------------------
board_modify_apps := ConnectivitySettings SystemUI Settings TeleService Telecom
...
override_property += \
    ro.flyme.romer=imcsg \
    ro.product.model_romer=scorpio_imcsg \
    ro.product.mod_device=scorpio_imcsg
